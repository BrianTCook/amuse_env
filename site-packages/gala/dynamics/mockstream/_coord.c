...
#define __PYX_HAVE__gala__dynamics__mockstream___coord
#define __PYX_HAVE_API__gala__dynamics__mockstream___coord
/* Early includes */
#include <math.h>
#include "math.h"
#include "pythread.h"
...
/* Module declarations from 'gala.dynamics.mockstream._coord' */
...
static void __pyx_f_4gala_8dynamics_10mockstream_6_coord_sat_rotation_matrix(double *, double *); /*proto*/
static void __pyx_f_4gala_8dynamics_10mockstream_6_coord_to_sat_coords(double *, double *, double *); /*proto*/
static void __pyx_f_4gala_8dynamics_10mockstream_6_coord_from_sat_coords(double *, double *, double *); /*proto*/
static void __pyx_f_4gala_8dynamics_10mockstream_6_coord_car_to_cyl(double *, double *); /*proto*/
static void __pyx_f_4gala_8dynamics_10mockstream_6_coord_cyl_to_car(double *, double *); /*proto*/
static PyObject *__pyx_f_4gala_8dynamics_10mockstream_6_coord__test_sat_rotation_matrix(int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_4gala_8dynamics_10mockstream_6_coord__test_to_sat_coords_roundtrip(int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_4gala_8dynamics_10mockstream_6_coord__test_car_to_cyl_roundtrip(int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_4gala_8dynamics_10mockstream_6_coord__test_cyl_to_car_roundtrip(int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "gala.dynamics.mockstream._coord"
extern int __pyx_module_is_main_gala__dynamics__mockstream___coord;
int __pyx_module_is_main_gala__dynamics__mockstream___coord = 0;

/* Implementation of 'gala.dynamics.mockstream._coord' */
...
static const char __pyx_k_Coordinate_help_for_generating[] = " Coordinate help for generating mock streams. ";
...
static PyObject *__pyx_pf_4gala_8dynamics_10mockstream_6_coord__test_sat_rotation_matrix(CYTHON_UNUSED PyObject *__pyx_self); /* proto */
static PyObject *__pyx_pf_4gala_8dynamics_10mockstream_6_coord_2_test_to_sat_coords_roundtrip(CYTHON_UNUSED PyObject *__pyx_self); /* proto */
static PyObject *__pyx_pf_4gala_8dynamics_10mockstream_6_coord_4_test_car_to_cyl_roundtrip(CYTHON_UNUSED PyObject *__pyx_self); /* proto */
static PyObject *__pyx_pf_4gala_8dynamics_10mockstream_6_coord_6_test_cyl_to_car_roundtrip(CYTHON_UNUSED PyObject *__pyx_self); /* proto */
...
/* "gala/dynamics/mockstream/_coord.pyx":21
...
static void __pyx_f_4gala_8dynamics_10mockstream_6_coord_sat_rotation_matrix(double *__pyx_v_w, double *__pyx_v_R) {
  double __pyx_v_x1_norm;
  double __pyx_v_x2_norm;
  double __pyx_v_x3_norm;
  ...
  __Pyx_RefNannySetupContext("sat_rotation_matrix", 0);

  /* "gala/dynamics/mockstream/_coord.pyx":24
 *                               double *R): # out
 *     cdef:
 ...
 */
  ...
  /* "gala/dynamics/mockstream/_coord.pyx":26
 *         double x1_norm, x2_norm, x3_norm = 0.
 *         unsigned int i
 *         double *x1 = [0.,0.,0.]             # <<<<<<<<<<<<<<
 *         double *x2 = [0.,0.,0.]
 ...
 */
  ...
  /* "gala/dynamics/mockstream/_coord.pyx":27
 *         unsigned int i
 *         double *x1 = [0.,0.,0.]
 *         double *x2 = [0.,0.,0.]             # <<<<<<<<<<<<<<
 *         double *x3 = [0.,0.,0.]
 ...
 */
  ...
  /* "gala/dynamics/mockstream/_coord.pyx":28
 *         double *x1 = [0.,0.,0.]
 *         double *x2 = [0.,0.,0.]
 *         double *x3 = [0.,0.,0.]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "gala/dynamics/mockstream/_coord.pyx":30
 *         double *x3 = [0.,0.,0.]
 * 
 *     x1[0] = w[0]             # <<<<<<<<<<<<<<
 *     x1[1] = w[1]
 *     x1[2] = w[2]
 */
  (__pyx_v_x1[0]) = (__pyx_v_w[0]);

  /* "gala/dynamics/mockstream/_coord.pyx":31
 * 
 *     x1[0] = w[0]
 *     x1[1] = w[1]             # <<<<<<<<<<<<<<
 *     x1[2] = w[2]
 * 
 */
  (__pyx_v_x1[1]) = (__pyx_v_w[1]);

  /* "gala/dynamics/mockstream/_coord.pyx":32
 *     x1[0] = w[0]
 *     x1[1] = w[1]
 *     x1[2] = w[2]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  (__pyx_v_x1[2]) = (__pyx_v_w[2]);

  /* "gala/dynamics/mockstream/_coord.pyx":34
 *     x1[2] = w[2]
 * 
 *     x3[0] = x1[1]*w[2+3] - x1[2]*w[1+3]             # <<<<<<<<<<<<<<
 ...
 */
  (__pyx_v_x3[0]) = (((__pyx_v_x1[1]) * (__pyx_v_w[5])) - ((__pyx_v_x1[2]) * (__pyx_v_w[4])));

  /* "gala/dynamics/mockstream/_coord.pyx":35
 * 
 *     x3[0] = x1[1]*w[2+3] - x1[2]*w[1+3]
 *     x3[1] = x1[2]*w[0+3] - x1[0]*w[2+3]             # <<<<<<<<<<<<<<
 *     x3[2] = x1[0]*w[1+3] - x1[1]*w[0+3]
 * 
 */
  (__pyx_v_x3[1]) = (((__pyx_v_x1[2]) * (__pyx_v_w[3])) - ((__pyx_v_x1[0]) * (__pyx_v_w[5])));

  /* "gala/dynamics/mockstream/_coord.pyx":36
 *     x3[0] = x1[1]*w[2+3] - x1[2]*w[1+3]
 *     x3[1] = x1[2]*w[0+3] - x1[0]*w[2+3]
 *     x3[2] = x1[0]*w[1+3] - x1[1]*w[0+3]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  (__pyx_v_x3[2]) = (((__pyx_v_x1[0]) * (__pyx_v_w[4])) - ((__pyx_v_x1[1]) * (__pyx_v_w[3])));

  /* "gala/dynamics/mockstream/_coord.pyx":38
 *     x3[2] = x1[0]*w[1+3] - x1[1]*w[0+3]
 * 
 *     x2[0] = -x1[1]*x3[2] + x1[2]*x3[1]             # <<<<<<<<<<<<<<
 ...
 */
  (__pyx_v_x2[0]) = (((-(__pyx_v_x1[1])) * (__pyx_v_x3[2])) + ((__pyx_v_x1[2]) * (__pyx_v_x3[1])));

  /* "gala/dynamics/mockstream/_coord.pyx":39
 * 
 *     x2[0] = -x1[1]*x3[2] + x1[2]*x3[1]
 *     x2[1] = -x1[2]*x3[0] + x1[0]*x3[2]             # <<<<<<<<<<<<<<
 *     x2[2] = -x1[0]*x3[1] + x1[1]*x3[0]
 * 
 */
  (__pyx_v_x2[1]) = (((-(__pyx_v_x1[2])) * (__pyx_v_x3[0])) + ((__pyx_v_x1[0]) * (__pyx_v_x3[2])));

  /* "gala/dynamics/mockstream/_coord.pyx":40
 *     x2[0] = -x1[1]*x3[2] + x1[2]*x3[1]
 *     x2[1] = -x1[2]*x3[0] + x1[0]*x3[2]
 *     x2[2] = -x1[0]*x3[1] + x1[1]*x3[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  (__pyx_v_x2[2]) = (((-(__pyx_v_x1[0])) * (__pyx_v_x3[1])) + ((__pyx_v_x1[1]) * (__pyx_v_x3[0])));

  /* "gala/dynamics/mockstream/_coord.pyx":42
 *     x2[2] = -x1[0]*x3[1] + x1[1]*x3[0]
 * 
 *     x1_norm = sqrt(x1[0]*x1[0] + x1[1]*x1[1] + x1[2]*x1[2])             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_x1_norm = sqrt(((((__pyx_v_x1[0]) * (__pyx_v_x1[0])) + ((__pyx_v_x1[1]) * (__pyx_v_x1[1]))) + ((__pyx_v_x1[2]) * (__pyx_v_x1[2]))));

  /* "gala/dynamics/mockstream/_coord.pyx":43
 * 
 *     x1_norm = sqrt(x1[0]*x1[0] + x1[1]*x1[1] + x1[2]*x1[2])
 *     x2_norm = sqrt(x2[0]*x2[0] + x2[1]*x2[1] + x2[2]*x2[2])             # <<<<<<<<<<<<<<
 *     x3_norm = sqrt(x3[0]*x3[0] + x3[1]*x3[1] + x3[2]*x3[2])
 * 
 */
  __pyx_v_x2_norm = sqrt(((((__pyx_v_x2[0]) * (__pyx_v_x2[0])) + ((__pyx_v_x2[1]) * (__pyx_v_x2[1]))) + ((__pyx_v_x2[2]) * (__pyx_v_x2[2]))));

  /* "gala/dynamics/mockstream/_coord.pyx":44
 *     x1_norm = sqrt(x1[0]*x1[0] + x1[1]*x1[1] + x1[2]*x1[2])
 *     x2_norm = sqrt(x2[0]*x2[0] + x2[1]*x2[1] + x2[2]*x2[2])
 *     x3_norm = sqrt(x3[0]*x3[0] + x3[1]*x3[1] + x3[2]*x3[2])             # <<<<<<<<<<<<<<
 * 
 *     for i in range(3):
 */
  __pyx_v_x3_norm = sqrt(((((__pyx_v_x3[0]) * (__pyx_v_x3[0])) + ((__pyx_v_x3[1]) * (__pyx_v_x3[1]))) + ((__pyx_v_x3[2]) * (__pyx_v_x3[2]))));

  /* "gala/dynamics/mockstream/_coord.pyx":46
 *     x3_norm = sqrt(x3[0]*x3[0] + x3[1]*x3[1] + x3[2]*x3[2])
 * 
 *     for i in range(3):             # <<<<<<<<<<<<<<
 *         x1[i] /= x1_norm
 ...
 */
  for (__pyx_t_4 = 0; __pyx_t_4 < 3; __pyx_t_4+=1) {
    ...
    /* "gala/dynamics/mockstream/_coord.pyx":47
 * 
 *     for i in range(3):
 *         x1[i] /= x1_norm             # <<<<<<<<<<<<<<
 *         x2[i] /= x2_norm
 ...
 */
    __pyx_t_5 = __pyx_v_i;
    (__pyx_v_x1[__pyx_t_5]) = ((__pyx_v_x1[__pyx_t_5]) / __pyx_v_x1_norm);

    /* "gala/dynamics/mockstream/_coord.pyx":48
 *     for i in range(3):
 *         x1[i] /= x1_norm
 *         x2[i] /= x2_norm             # <<<<<<<<<<<<<<
 *         x3[i] /= x3_norm
 ...
 */
    __pyx_t_5 = __pyx_v_i;
    (__pyx_v_x2[__pyx_t_5]) = ((__pyx_v_x2[__pyx_t_5]) / __pyx_v_x2_norm);

    /* "gala/dynamics/mockstream/_coord.pyx":49
 *         x1[i] /= x1_norm
 *         x2[i] /= x2_norm
 *         x3[i] /= x3_norm             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_5 = __pyx_v_i;
    (__pyx_v_x3[__pyx_t_5]) = ((__pyx_v_x3[__pyx_t_5]) / __pyx_v_x3_norm);
  }

  /* "gala/dynamics/mockstream/_coord.pyx":51
 *         x3[i] /= x3_norm
 * 
 *     R[0] = x1[0]             # <<<<<<<<<<<<<<
 *     R[1] = x1[1]
 *     R[2] = x1[2]
 */
  (__pyx_v_R[0]) = (__pyx_v_x1[0]);

  /* "gala/dynamics/mockstream/_coord.pyx":52
 * 
 *     R[0] = x1[0]
 *     R[1] = x1[1]             # <<<<<<<<<<<<<<
 *     R[2] = x1[2]
 *     R[3] = x2[0]
 */
  (__pyx_v_R[1]) = (__pyx_v_x1[1]);

  /* "gala/dynamics/mockstream/_coord.pyx":53
 *     R[0] = x1[0]
 *     R[1] = x1[1]
 *     R[2] = x1[2]             # <<<<<<<<<<<<<<
 *     R[3] = x2[0]
 *     R[4] = x2[1]
 */
  (__pyx_v_R[2]) = (__pyx_v_x1[2]);

  /* "gala/dynamics/mockstream/_coord.pyx":54
 *     R[1] = x1[1]
 *     R[2] = x1[2]
 *     R[3] = x2[0]             # <<<<<<<<<<<<<<
 *     R[4] = x2[1]
 *     R[5] = x2[2]
 */
  (__pyx_v_R[3]) = (__pyx_v_x2[0]);

  /* "gala/dynamics/mockstream/_coord.pyx":55
 *     R[2] = x1[2]
 *     R[3] = x2[0]
 *     R[4] = x2[1]             # <<<<<<<<<<<<<<
 *     R[5] = x2[2]
 *     R[6] = x3[0]
 */
  (__pyx_v_R[4]) = (__pyx_v_x2[1]);

  /* "gala/dynamics/mockstream/_coord.pyx":56
 *     R[3] = x2[0]
 *     R[4] = x2[1]
 *     R[5] = x2[2]             # <<<<<<<<<<<<<<
 *     R[6] = x3[0]
 *     R[7] = x3[1]
 */
  (__pyx_v_R[5]) = (__pyx_v_x2[2]);

  /* "gala/dynamics/mockstream/_coord.pyx":57
 *     R[4] = x2[1]
 *     R[5] = x2[2]
 *     R[6] = x3[0]             # <<<<<<<<<<<<<<
 *     R[7] = x3[1]
 *     R[8] = x3[2]
 */
  (__pyx_v_R[6]) = (__pyx_v_x3[0]);

  /* "gala/dynamics/mockstream/_coord.pyx":58
 *     R[5] = x2[2]
 *     R[6] = x3[0]
 *     R[7] = x3[1]             # <<<<<<<<<<<<<<
 *     R[8] = x3[2]
 * 
 */
  (__pyx_v_R[7]) = (__pyx_v_x3[1]);

  /* "gala/dynamics/mockstream/_coord.pyx":59
 *     R[6] = x3[0]
 *     R[7] = x3[1]
 *     R[8] = x3[2]             # <<<<<<<<<<<<<<
 * 
...
/* "gala/dynamics/mockstream/_coord.pyx":61
 *     R[8] = x3[2]
 * 
 * cdef void to_sat_coords(double *w, double *R, # in             # <<<<<<<<<<<<<<
 *                         double *w_prime): # out
...
static void __pyx_f_4gala_8dynamics_10mockstream_6_coord_to_sat_coords(double *__pyx_v_w, double *__pyx_v_R, double *__pyx_v_w_prime) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("to_sat_coords", 0);

  /* "gala/dynamics/mockstream/_coord.pyx":67
 * 
 ...
 */
  (__pyx_v_w_prime[0]) = ((((__pyx_v_w[0]) * (__pyx_v_R[0])) + ((__pyx_v_w[1]) * (__pyx_v_R[1]))) + ((__pyx_v_w[2]) * (__pyx_v_R[2])));

  /* "gala/dynamics/mockstream/_coord.pyx":68
 *     # Project into new basis
 *     w_prime[0] = w[0]*R[0] + w[1]*R[1] + w[2]*R[2]
 *     w_prime[1] = w[0]*R[3] + w[1]*R[4] + w[2]*R[5]             # <<<<<<<<<<<<<<
 *     w_prime[2] = w[0]*R[6] + w[1]*R[7] + w[2]*R[8]
 * 
 */
  (__pyx_v_w_prime[1]) = ((((__pyx_v_w[0]) * (__pyx_v_R[3])) + ((__pyx_v_w[1]) * (__pyx_v_R[4]))) + ((__pyx_v_w[2]) * (__pyx_v_R[5])));

  /* "gala/dynamics/mockstream/_coord.pyx":69
 *     w_prime[0] = w[0]*R[0] + w[1]*R[1] + w[2]*R[2]
 *     w_prime[1] = w[0]*R[3] + w[1]*R[4] + w[2]*R[5]
 *     w_prime[2] = w[0]*R[6] + w[1]*R[7] + w[2]*R[8]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  (__pyx_v_w_prime[2]) = ((((__pyx_v_w[0]) * (__pyx_v_R[6])) + ((__pyx_v_w[1]) * (__pyx_v_R[7]))) + ((__pyx_v_w[2]) * (__pyx_v_R[8])));

  /* "gala/dynamics/mockstream/_coord.pyx":71
 *     w_prime[2] = w[0]*R[6] + w[1]*R[7] + w[2]*R[8]
 * 
 *     w_prime[3] = w[3]*R[0] + w[4]*R[1] + w[5]*R[2]             # <<<<<<<<<<<<<<
 ...
 */
  (__pyx_v_w_prime[3]) = ((((__pyx_v_w[3]) * (__pyx_v_R[0])) + ((__pyx_v_w[4]) * (__pyx_v_R[1]))) + ((__pyx_v_w[5]) * (__pyx_v_R[2])));

  /* "gala/dynamics/mockstream/_coord.pyx":72
 * 
 *     w_prime[3] = w[3]*R[0] + w[4]*R[1] + w[5]*R[2]
 *     w_prime[4] = w[3]*R[3] + w[4]*R[4] + w[5]*R[5]             # <<<<<<<<<<<<<<
 *     w_prime[5] = w[3]*R[6] + w[4]*R[7] + w[5]*R[8]
 * 
 */
  (__pyx_v_w_prime[4]) = ((((__pyx_v_w[3]) * (__pyx_v_R[3])) + ((__pyx_v_w[4]) * (__pyx_v_R[4]))) + ((__pyx_v_w[5]) * (__pyx_v_R[5])));

  /* "gala/dynamics/mockstream/_coord.pyx":73
 *     w_prime[3] = w[3]*R[0] + w[4]*R[1] + w[5]*R[2]
 *     w_prime[4] = w[3]*R[3] + w[4]*R[4] + w[5]*R[5]
 *     w_prime[5] = w[3]*R[6] + w[4]*R[7] + w[5]*R[8]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  (__pyx_v_w_prime[5]) = ((((__pyx_v_w[3]) * (__pyx_v_R[6])) + ((__pyx_v_w[4]) * (__pyx_v_R[7]))) + ((__pyx_v_w[5]) * (__pyx_v_R[8])));
...
/* "gala/dynamics/mockstream/_coord.pyx":75
 *     w_prime[5] = w[3]*R[6] + w[4]*R[7] + w[5]*R[8]
 * 
 * cdef void from_sat_coords(double *w_prime, double *R, # in             # <<<<<<<<<<<<<<
 *                           double *w): # out
...
static void __pyx_f_4gala_8dynamics_10mockstream_6_coord_from_sat_coords(double *__pyx_v_w_prime, double *__pyx_v_R, double *__pyx_v_w) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("from_sat_coords", 0);

  /* "gala/dynamics/mockstream/_coord.pyx":80
 * 
 ...
 */
  (__pyx_v_w[0]) = ((((__pyx_v_w_prime[0]) * (__pyx_v_R[0])) + ((__pyx_v_w_prime[1]) * (__pyx_v_R[3]))) + ((__pyx_v_w_prime[2]) * (__pyx_v_R[6])));

  /* "gala/dynamics/mockstream/_coord.pyx":81
 *     # Project back from sat plane
 *     w[0] = w_prime[0]*R[0] + w_prime[1]*R[3] + w_prime[2]*R[6]
 *     w[1] = w_prime[0]*R[1] + w_prime[1]*R[4] + w_prime[2]*R[7]             # <<<<<<<<<<<<<<
 *     w[2] = w_prime[0]*R[2] + w_prime[1]*R[5] + w_prime[2]*R[8]
 * 
 */
  (__pyx_v_w[1]) = ((((__pyx_v_w_prime[0]) * (__pyx_v_R[1])) + ((__pyx_v_w_prime[1]) * (__pyx_v_R[4]))) + ((__pyx_v_w_prime[2]) * (__pyx_v_R[7])));

  /* "gala/dynamics/mockstream/_coord.pyx":82
 *     w[0] = w_prime[0]*R[0] + w_prime[1]*R[3] + w_prime[2]*R[6]
 *     w[1] = w_prime[0]*R[1] + w_prime[1]*R[4] + w_prime[2]*R[7]
 *     w[2] = w_prime[0]*R[2] + w_prime[1]*R[5] + w_prime[2]*R[8]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  (__pyx_v_w[2]) = ((((__pyx_v_w_prime[0]) * (__pyx_v_R[2])) + ((__pyx_v_w_prime[1]) * (__pyx_v_R[5]))) + ((__pyx_v_w_prime[2]) * (__pyx_v_R[8])));

  /* "gala/dynamics/mockstream/_coord.pyx":84
 *     w[2] = w_prime[0]*R[2] + w_prime[1]*R[5] + w_prime[2]*R[8]
 * 
 *     w[3] = w_prime[3]*R[0] + w_prime[4]*R[3] + w_prime[5]*R[6]             # <<<<<<<<<<<<<<
 ...
 */
  (__pyx_v_w[3]) = ((((__pyx_v_w_prime[3]) * (__pyx_v_R[0])) + ((__pyx_v_w_prime[4]) * (__pyx_v_R[3]))) + ((__pyx_v_w_prime[5]) * (__pyx_v_R[6])));

  /* "gala/dynamics/mockstream/_coord.pyx":85
 * 
 *     w[3] = w_prime[3]*R[0] + w_prime[4]*R[3] + w_prime[5]*R[6]
 *     w[4] = w_prime[3]*R[1] + w_prime[4]*R[4] + w_prime[5]*R[7]             # <<<<<<<<<<<<<<
 *     w[5] = w_prime[3]*R[2] + w_prime[4]*R[5] + w_prime[5]*R[8]
 * 
 */
  (__pyx_v_w[4]) = ((((__pyx_v_w_prime[3]) * (__pyx_v_R[1])) + ((__pyx_v_w_prime[4]) * (__pyx_v_R[4]))) + ((__pyx_v_w_prime[5]) * (__pyx_v_R[7])));

  /* "gala/dynamics/mockstream/_coord.pyx":86
 *     w[3] = w_prime[3]*R[0] + w_prime[4]*R[3] + w_prime[5]*R[6]
 *     w[4] = w_prime[3]*R[1] + w_prime[4]*R[4] + w_prime[5]*R[7]
 *     w[5] = w_prime[3]*R[2] + w_prime[4]*R[5] + w_prime[5]*R[8]             # <<<<<<<<<<<<<<
 * 
 * # ---------------------------------------------------------------------
 */
  (__pyx_v_w[5]) = ((((__pyx_v_w_prime[3]) * (__pyx_v_R[2])) + ((__pyx_v_w_prime[4]) * (__pyx_v_R[5]))) + ((__pyx_v_w_prime[5]) * (__pyx_v_R[8])));
...
/* "gala/dynamics/mockstream/_coord.pyx":90
 * # ---------------------------------------------------------------------
 * 
...
static void __pyx_f_4gala_8dynamics_10mockstream_6_coord_car_to_cyl(double *__pyx_v_w, double *__pyx_v_cyl) {
  double __pyx_v_R;
  double __pyx_v_phi;
  double __pyx_v_vR;
  double __pyx_v_vphi;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  __Pyx_RefNannySetupContext("car_to_cyl", 0);

  /* "gala/dynamics/mockstream/_coord.pyx":93
 *                      double *cyl): # out
 *     cdef:
 ...
 */
  __pyx_v_R = sqrt((((__pyx_v_w[0]) * (__pyx_v_w[0])) + ((__pyx_v_w[1]) * (__pyx_v_w[1]))));

  /* "gala/dynamics/mockstream/_coord.pyx":94
 *     cdef:
 *         double R = sqrt(w[0]*w[0] + w[1]*w[1])
 *         double phi = atan2(w[1], w[0])             # <<<<<<<<<<<<<<
 *         double vR = (w[0]*w[3] + w[1]*w[4]) / R
 ...
 */
  __pyx_v_phi = atan2((__pyx_v_w[1]), (__pyx_v_w[0]));

  /* "gala/dynamics/mockstream/_coord.pyx":95
 *         double R = sqrt(w[0]*w[0] + w[1]*w[1])
 *         double phi = atan2(w[1], w[0])
 *         double vR = (w[0]*w[3] + w[1]*w[4]) / R             # <<<<<<<<<<<<<<
 *         double vphi = (w[0]*w[4] - w[3]*w[1]) / R
 * 
 */
  __pyx_v_vR = ((((__pyx_v_w[0]) * (__pyx_v_w[3])) + ((__pyx_v_w[1]) * (__pyx_v_w[4]))) / __pyx_v_R);

  /* "gala/dynamics/mockstream/_coord.pyx":96
 *         double phi = atan2(w[1], w[0])
 *         double vR = (w[0]*w[3] + w[1]*w[4]) / R
 *         double vphi = (w[0]*w[4] - w[3]*w[1]) / R             # <<<<<<<<<<<<<<
 * 
 *     cyl[0] = R
 */
  __pyx_v_vphi = ((((__pyx_v_w[0]) * (__pyx_v_w[4])) - ((__pyx_v_w[3]) * (__pyx_v_w[1]))) / __pyx_v_R);

  /* "gala/dynamics/mockstream/_coord.pyx":98
 *         double vphi = (w[0]*w[4] - w[3]*w[1]) / R
 * 
 *     cyl[0] = R             # <<<<<<<<<<<<<<
 *     if phi < 0:
 *         phi = phi + 2*M_PI
 */
  (__pyx_v_cyl[0]) = __pyx_v_R;

  /* "gala/dynamics/mockstream/_coord.pyx":99
 * 
 *     cyl[0] = R
 *     if phi < 0:             # <<<<<<<<<<<<<<
 *         phi = phi + 2*M_PI
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "gala/dynamics/mockstream/_coord.pyx":100
 *     cyl[0] = R
 *     if phi < 0:
 *         phi = phi + 2*M_PI             # <<<<<<<<<<<<<<
 *     cyl[1] = phi
 *     cyl[2] = w[2]
 */
    __pyx_v_phi = (__pyx_v_phi + (2.0 * M_PI));
 ...
 */
  ...
  /* "gala/dynamics/mockstream/_coord.pyx":101
 *     if phi < 0:
 *         phi = phi + 2*M_PI
 *     cyl[1] = phi             # <<<<<<<<<<<<<<
 *     cyl[2] = w[2]
 * 
 */
  (__pyx_v_cyl[1]) = __pyx_v_phi;

  /* "gala/dynamics/mockstream/_coord.pyx":102
 *         phi = phi + 2*M_PI
 *     cyl[1] = phi
 *     cyl[2] = w[2]             # <<<<<<<<<<<<<<
 * 
 *     cyl[3] = vR
 */
  (__pyx_v_cyl[2]) = (__pyx_v_w[2]);

  /* "gala/dynamics/mockstream/_coord.pyx":104
 *     cyl[2] = w[2]
 * 
 *     cyl[3] = vR             # <<<<<<<<<<<<<<
 *     cyl[4] = vphi
 *     cyl[5] = w[5]
 */
  (__pyx_v_cyl[3]) = __pyx_v_vR;

  /* "gala/dynamics/mockstream/_coord.pyx":105
 * 
 *     cyl[3] = vR
 *     cyl[4] = vphi             # <<<<<<<<<<<<<<
 *     cyl[5] = w[5]
 * 
 */
  (__pyx_v_cyl[4]) = __pyx_v_vphi;

  /* "gala/dynamics/mockstream/_coord.pyx":106
 *     cyl[3] = vR
 *     cyl[4] = vphi
 *     cyl[5] = w[5]             # <<<<<<<<<<<<<<
 * 
...
/* "gala/dynamics/mockstream/_coord.pyx":108
 *     cyl[5] = w[5]
 * 
 * cdef void cyl_to_car(double *cyl, # in             # <<<<<<<<<<<<<<
 *                      double *w): # out
...
static void __pyx_f_4gala_8dynamics_10mockstream_6_coord_cyl_to_car(double *__pyx_v_cyl, double *__pyx_v_w) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("cyl_to_car", 0);

  /* "gala/dynamics/mockstream/_coord.pyx":110
 * cdef void cyl_to_car(double *cyl, # in
 *                      double *w): # out
 *     w[0] = cyl[0] * cos(cyl[1])             # <<<<<<<<<<<<<<
 *     w[1] = cyl[0] * sin(cyl[1])
 *     w[2] = cyl[2]
 */
  (__pyx_v_w[0]) = ((__pyx_v_cyl[0]) * cos((__pyx_v_cyl[1])));

  /* "gala/dynamics/mockstream/_coord.pyx":111
 *                      double *w): # out
 *     w[0] = cyl[0] * cos(cyl[1])
 *     w[1] = cyl[0] * sin(cyl[1])             # <<<<<<<<<<<<<<
 *     w[2] = cyl[2]
 * 
 */
  (__pyx_v_w[1]) = ((__pyx_v_cyl[0]) * sin((__pyx_v_cyl[1])));

  /* "gala/dynamics/mockstream/_coord.pyx":112
 *     w[0] = cyl[0] * cos(cyl[1])
 *     w[1] = cyl[0] * sin(cyl[1])
 *     w[2] = cyl[2]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  (__pyx_v_w[2]) = (__pyx_v_cyl[2]);

  /* "gala/dynamics/mockstream/_coord.pyx":114
 *     w[2] = cyl[2]
 * 
 *     w[3] = cyl[3] * cos(cyl[1]) - cyl[4] * sin(cyl[1])             # <<<<<<<<<<<<<<
 ...
 *     w[5] = cyl[5]
 */
  (__pyx_v_w[3]) = (((__pyx_v_cyl[3]) * cos((__pyx_v_cyl[1]))) - ((__pyx_v_cyl[4]) * sin((__pyx_v_cyl[1]))));

  /* "gala/dynamics/mockstream/_coord.pyx":115
 * 
 *     w[3] = cyl[3] * cos(cyl[1]) - cyl[4] * sin(cyl[1])
 *     w[4] = cyl[3] * sin(cyl[1]) + cyl[4] * cos(cyl[1])             # <<<<<<<<<<<<<<
 *     w[5] = cyl[5]
 * 
 */
  (__pyx_v_w[4]) = (((__pyx_v_cyl[3]) * sin((__pyx_v_cyl[1]))) + ((__pyx_v_cyl[4]) * cos((__pyx_v_cyl[1]))));

  /* "gala/dynamics/mockstream/_coord.pyx":116
 *     w[3] = cyl[3] * cos(cyl[1]) - cyl[4] * sin(cyl[1])
 *     w[4] = cyl[3] * sin(cyl[1]) + cyl[4] * cos(cyl[1])
 *     w[5] = cyl[5]             # <<<<<<<<<<<<<<
 * 
...
/* "gala/dynamics/mockstream/_coord.pyx":122
 * #
 * 
...
static PyObject *__pyx_pw_4gala_8dynamics_10mockstream_6_coord_1_test_sat_rotation_matrix(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_f_4gala_8dynamics_10mockstream_6_coord__test_sat_rotation_matrix(CYTHON_UNUSED int __pyx_skip_dispatch) {
  PyObject *__pyx_v_np = NULL;
  long __pyx_v_n;
  __Pyx_memviewslice __pyx_v_w = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_wrot = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  size_t __pyx_t_25;
  size_t __pyx_t_26;
  __Pyx_RefNannySetupContext("_test_sat_rotation_matrix", 0);

  /* "gala/dynamics/mockstream/_coord.pyx":123
 * 
 * cpdef _test_sat_rotation_matrix():
 *     import numpy as np             # <<<<<<<<<<<<<<
 *     np.random.seed(42)
 *     n = 1024
 */
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_numpy, 0, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 123, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_np = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "gala/dynamics/mockstream/_coord.pyx":124
 * cpdef _test_sat_rotation_matrix():
 *     import numpy as np
 *     np.random.seed(42)             # <<<<<<<<<<<<<<
 *     n = 1024
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_random); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 124, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_seed); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 124, __pyx_L1_error)
  ...
  /* "gala/dynamics/mockstream/_coord.pyx":125
 *     import numpy as np
 *     np.random.seed(42)
 *     n = 1024             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "gala/dynamics/mockstream/_coord.pyx":128
 * 
 *     cdef:
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_zeros); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 128, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_tuple__2, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 128, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_3 = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_t_2, PyBUF_WRITABLE); if (unlikely(!__pyx_t_3.memview)) __PYX_ERR(0, 128, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_w = __pyx_t_3;
  __pyx_t_3.memview = NULL;
  __pyx_t_3.data = NULL;

  /* "gala/dynamics/mockstream/_coord.pyx":129
 *     cdef:
 *         double[::1] w = np.zeros(6)
 *         double[::1] wrot = np.zeros(6)             # <<<<<<<<<<<<<<
 *         double[::1] w2 = np.zeros(6)
 ...
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_zeros); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 129, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_tuple__3, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 129, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_3 = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_3.memview)) __PYX_ERR(0, 129, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_wrot = __pyx_t_3;
  __pyx_t_3.memview = NULL;
  __pyx_t_3.data = NULL;

  /* "gala/dynamics/mockstream/_coord.pyx":130
 *         double[::1] w = np.zeros(6)
 *         double[::1] wrot = np.zeros(6)
 *         double[::1] w2 = np.zeros(6)             # <<<<<<<<<<<<<<
 *         double[:,::1] R = np.zeros((3,3))
 *         unsigned int i, j
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_zeros); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 130, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_tuple__4, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 130, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  /* "gala/dynamics/mockstream/_coord.pyx":131
 *         double[::1] wrot = np.zeros(6)
 *         double[::1] w2 = np.zeros(6)
 *         double[:,::1] R = np.zeros((3,3))             # <<<<<<<<<<<<<<
 *         unsigned int i, j
 * 
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_zeros); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 131, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_tuple__6, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 131, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_4 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_4.memview)) __PYX_ERR(0, 131, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_R = __pyx_t_4;
  __pyx_t_4.memview = NULL;
  __pyx_t_4.data = NULL;

  /* "gala/dynamics/mockstream/_coord.pyx":134
 *         unsigned int i, j
 * 
 *     for i in range(n):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
    ...
    /* "gala/dynamics/mockstream/_coord.pyx":135
 * 
 *     for i in range(n):
 *         w = np.random.uniform(size=6)             # <<<<<<<<<<<<<<
 *         sat_rotation_matrix(&w[0], &R[0,0])
 * 
 */
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_random); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 135, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_uniform); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 135, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = __Pyx_PyDict_NewPresized(1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 135, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_size, __pyx_int_6) < 0) __PYX_ERR(0, 135, __pyx_L1_error)
    __pyx_t_8 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_empty_tuple, __pyx_t_1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 135, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_3 = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_t_8, PyBUF_WRITABLE); if (unlikely(!__pyx_t_3.memview)) __PYX_ERR(0, 135, __pyx_L1_error)
    ...
    /* "gala/dynamics/mockstream/_coord.pyx":136
 *     for i in range(n):
 *         w = np.random.uniform(size=6)
 *         sat_rotation_matrix(&w[0], &R[0,0])             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_10 = 0;
    __pyx_t_11 = 0;
    __pyx_f_4gala_8dynamics_10mockstream_6_coord_sat_rotation_matrix((&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_w.data) + __pyx_t_9)) )))), (&(*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_R.data + __pyx_t_10 * __pyx_v_R.strides[0]) )) + __pyx_t_11)) )))));

    /* "gala/dynamics/mockstream/_coord.pyx":138
 *         sat_rotation_matrix(&w[0], &R[0,0])
 * 
 *         x = np.array(R).dot(np.array(w)[:3])             # <<<<<<<<<<<<<<
 *         assert x[0] > 0
 ...
 */
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_array); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 138, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_12 = __pyx_memoryview_fromslice(__pyx_v_R, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 138, __pyx_L1_error)
    ...
    if (!__pyx_t_13) {
      __pyx_t_1 = __Pyx_PyObject_CallOneArg(__pyx_t_2, __pyx_t_12); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 138, __pyx_L1_error)
      ...
      #endif
      {
        ...
        __pyx_t_12 = 0;
        __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_14, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 138, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
      }
    }
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_dot); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 138, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_14 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_array); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 138, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_14);
    __pyx_t_12 = __pyx_memoryview_fromslice(__pyx_v_w, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 138, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __pyx_t_13 = NULL;
    ...
    if (!__pyx_t_13) {
      __pyx_t_1 = __Pyx_PyObject_CallOneArg(__pyx_t_14, __pyx_t_12); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 138, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
      __Pyx_GOTREF(__pyx_t_1);
    } else {
      #if CYTHON_FAST_PYCALL
      if (PyFunction_Check(__pyx_t_14)) {
        PyObject *__pyx_temp[2] = {__pyx_t_13, __pyx_t_12};
        __pyx_t_1 = __Pyx_PyFunction_FastCall(__pyx_t_14, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 138, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_13); __pyx_t_13 = 0;
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
      } else
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_14)) {
        PyObject *__pyx_temp[2] = {__pyx_t_13, __pyx_t_12};
        __pyx_t_1 = __Pyx_PyCFunction_FastCall(__pyx_t_14, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 138, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_13); __pyx_t_13 = 0;
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
      } else
      #endif
      {
        ...
        __pyx_t_12 = 0;
        __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_14, __pyx_t_15, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 138, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;
      }
    }
    __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
    __pyx_t_14 = __Pyx_PyObject_GetSlice(__pyx_t_1, 0, 3, NULL, NULL, &__pyx_slice__7, 0, 1, 0); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 138, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_14);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = NULL;
    if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_2))) {
    ...
    if (!__pyx_t_1) {
      __pyx_t_8 = __Pyx_PyObject_CallOneArg(__pyx_t_2, __pyx_t_14); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 138, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
      __Pyx_GOTREF(__pyx_t_8);
    } else {
      #if CYTHON_FAST_PYCALL
      ...
      #endif
      {
        ...
        __pyx_t_14 = 0;
        __pyx_t_8 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_15, NULL); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 138, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;
      }
    }
    ...
    /* "gala/dynamics/mockstream/_coord.pyx":139
 * 
 *         x = np.array(R).dot(np.array(w)[:3])
 *         assert x[0] > 0             # <<<<<<<<<<<<<<
 *         assert np.allclose(x[1], 0)
 ...
 */
    ...
    if (unlikely(!Py_OptimizeFlag)) {
      __pyx_t_8 = __Pyx_GetItemInt(__pyx_v_x, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 139, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_8);
      __pyx_t_2 = PyObject_RichCompare(__pyx_t_8, __pyx_int_0, Py_GT); __Pyx_XGOTREF(__pyx_t_2); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 139, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      __pyx_t_16 = __Pyx_PyObject_IsTrue(__pyx_t_2); if (unlikely(__pyx_t_16 < 0)) __PYX_ERR(0, 139, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    ...
    /* "gala/dynamics/mockstream/_coord.pyx":140
 *         x = np.array(R).dot(np.array(w)[:3])
 *         assert x[0] > 0
 *         assert np.allclose(x[1], 0)             # <<<<<<<<<<<<<<
 *         assert np.allclose(x[2], 0)
 ...
 */
    #ifndef CYTHON_WITHOUT_ASSERTIONS
    if (unlikely(!Py_OptimizeFlag)) {
      __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_allclose); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 140, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_8);
      __pyx_t_15 = __Pyx_GetItemInt(__pyx_v_x, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 140, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_15);
      __pyx_t_14 = NULL;
      __pyx_t_17 = 0;
      ...
      if (PyFunction_Check(__pyx_t_8)) {
        PyObject *__pyx_temp[3] = {__pyx_t_14, __pyx_t_15, __pyx_int_0};
        __pyx_t_2 = __Pyx_PyFunction_FastCall(__pyx_t_8, __pyx_temp+1-__pyx_t_17, 2+__pyx_t_17); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 140, __pyx_L1_error)
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_8)) {
        PyObject *__pyx_temp[3] = {__pyx_t_14, __pyx_t_15, __pyx_int_0};
        __pyx_t_2 = __Pyx_PyCFunction_FastCall(__pyx_t_8, __pyx_temp+1-__pyx_t_17, 2+__pyx_t_17); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 140, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_14); __pyx_t_14 = 0;
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;
      } else
      #endif
      {
        __pyx_t_1 = PyTuple_New(2+__pyx_t_17); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 140, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        if (__pyx_t_14) {
        ...
        PyTuple_SET_ITEM(__pyx_t_1, 1+__pyx_t_17, __pyx_int_0);
        __pyx_t_15 = 0;
        __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_8, __pyx_t_1, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 140, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      }
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      __pyx_t_16 = __Pyx_PyObject_IsTrue(__pyx_t_2); if (unlikely(__pyx_t_16 < 0)) __PYX_ERR(0, 140, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      if (unlikely(!__pyx_t_16)) {
        PyErr_SetNone(PyExc_AssertionError);
    ...
    /* "gala/dynamics/mockstream/_coord.pyx":141
 *         assert x[0] > 0
 *         assert np.allclose(x[1], 0)
 *         assert np.allclose(x[2], 0)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    #ifndef CYTHON_WITHOUT_ASSERTIONS
    if (unlikely(!Py_OptimizeFlag)) {
      __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_allclose); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 141, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_8);
      __pyx_t_1 = __Pyx_GetItemInt(__pyx_v_x, 2, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 141, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_15 = NULL;
      __pyx_t_17 = 0;
      if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_8))) {
      ...
      #if CYTHON_FAST_PYCALL
      if (PyFunction_Check(__pyx_t_8)) {
        PyObject *__pyx_temp[3] = {__pyx_t_15, __pyx_t_1, __pyx_int_0};
        __pyx_t_2 = __Pyx_PyFunction_FastCall(__pyx_t_8, __pyx_temp+1-__pyx_t_17, 2+__pyx_t_17); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 141, __pyx_L1_error)
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_8)) {
        PyObject *__pyx_temp[3] = {__pyx_t_15, __pyx_t_1, __pyx_int_0};
        __pyx_t_2 = __Pyx_PyCFunction_FastCall(__pyx_t_8, __pyx_temp+1-__pyx_t_17, 2+__pyx_t_17); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 141, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_15); __pyx_t_15 = 0;
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      } else
      #endif
      {
        __pyx_t_14 = PyTuple_New(2+__pyx_t_17); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 141, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_14);
        if (__pyx_t_15) {
          __Pyx_GIVEREF(__pyx_t_15); PyTuple_SET_ITEM(__pyx_t_14, 0, __pyx_t_15); __pyx_t_15 = NULL;
        }
        __Pyx_GIVEREF(__pyx_t_1);
        PyTuple_SET_ITEM(__pyx_t_14, 0+__pyx_t_17, __pyx_t_1);
        __Pyx_INCREF(__pyx_int_0);
        __Pyx_GIVEREF(__pyx_int_0);
        PyTuple_SET_ITEM(__pyx_t_14, 1+__pyx_t_17, __pyx_int_0);
        __pyx_t_1 = 0;
        __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_8, __pyx_t_14, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 141, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
      }
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      __pyx_t_16 = __Pyx_PyObject_IsTrue(__pyx_t_2); if (unlikely(__pyx_t_16 < 0)) __PYX_ERR(0, 141, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      if (unlikely(!__pyx_t_16)) {
        PyErr_SetNone(PyExc_AssertionError);
    ...
    /* "gala/dynamics/mockstream/_coord.pyx":143
 *         assert np.allclose(x[2], 0)
 * 
 *         v = np.array(R).dot(np.array(w)[3:])             # <<<<<<<<<<<<<<
 ...
 *         for j in range(3):
 */
    __pyx_t_14 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_array); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 143, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_14);
    __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_R, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 143, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_15 = NULL;
    if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_14))) {
    ...
    if (!__pyx_t_15) {
      __pyx_t_8 = __Pyx_PyObject_CallOneArg(__pyx_t_14, __pyx_t_1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 143, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __Pyx_GOTREF(__pyx_t_8);
    } else {
      #if CYTHON_FAST_PYCALL
      if (PyFunction_Check(__pyx_t_14)) {
        ...
        __pyx_t_8 = __Pyx_PyFunction_FastCall(__pyx_t_14, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 143, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_15); __pyx_t_15 = 0;
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      } else
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_14)) {
        PyObject *__pyx_temp[2] = {__pyx_t_15, __pyx_t_1};
        __pyx_t_8 = __Pyx_PyCFunction_FastCall(__pyx_t_14, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 143, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_15); __pyx_t_15 = 0;
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      } else
      #endif
      {
        __pyx_t_12 = PyTuple_New(1+1); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 143, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_12);
        ...
        __pyx_t_1 = 0;
        __pyx_t_8 = __Pyx_PyObject_Call(__pyx_t_14, __pyx_t_12, NULL); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 143, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
      }
    }
    __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
    __pyx_t_14 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_dot); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 143, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_14);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_12 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_array); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 143, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_w, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 143, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_15 = NULL;
    ...
    if (!__pyx_t_15) {
      __pyx_t_8 = __Pyx_PyObject_CallOneArg(__pyx_t_12, __pyx_t_1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 143, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __Pyx_GOTREF(__pyx_t_8);
    } else {
      #if CYTHON_FAST_PYCALL
      if (PyFunction_Check(__pyx_t_12)) {
        PyObject *__pyx_temp[2] = {__pyx_t_15, __pyx_t_1};
        __pyx_t_8 = __Pyx_PyFunction_FastCall(__pyx_t_12, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 143, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_15); __pyx_t_15 = 0;
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      } else
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_12)) {
        PyObject *__pyx_temp[2] = {__pyx_t_15, __pyx_t_1};
        __pyx_t_8 = __Pyx_PyCFunction_FastCall(__pyx_t_12, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 143, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_15); __pyx_t_15 = 0;
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      } else
      #endif
      {
        ...
        __pyx_t_1 = 0;
        __pyx_t_8 = __Pyx_PyObject_Call(__pyx_t_12, __pyx_t_13, NULL); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 143, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      }
    }
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
    __pyx_t_12 = __Pyx_PyObject_GetSlice(__pyx_t_8, 3, 0, NULL, NULL, &__pyx_slice__8, 1, 0, 0); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 143, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_8 = NULL;
    if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_14))) {
    ...
    if (!__pyx_t_8) {
      __pyx_t_2 = __Pyx_PyObject_CallOneArg(__pyx_t_14, __pyx_t_12); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 143, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
      __Pyx_GOTREF(__pyx_t_2);
    } else {
      #if CYTHON_FAST_PYCALL
      if (PyFunction_Check(__pyx_t_14)) {
        ...
        __pyx_t_2 = __Pyx_PyFunction_FastCall(__pyx_t_14, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 143, __pyx_L1_error)
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_14)) {
        PyObject *__pyx_temp[2] = {__pyx_t_8, __pyx_t_12};
        __pyx_t_2 = __Pyx_PyCFunction_FastCall(__pyx_t_14, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 143, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_8); __pyx_t_8 = 0;
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
      } else
      #endif
      {
        ...
        __pyx_t_12 = 0;
        __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_14, __pyx_t_13, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 143, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      }
    }
    ...
    /* "gala/dynamics/mockstream/_coord.pyx":144
 * 
 *         v = np.array(R).dot(np.array(w)[3:])
 *         assert np.allclose(v[2], 0)             # <<<<<<<<<<<<<<
 *         for j in range(3):
 ...
 */
    #ifndef CYTHON_WITHOUT_ASSERTIONS
    if (unlikely(!Py_OptimizeFlag)) {
      __pyx_t_14 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_allclose); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 144, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_14);
      __pyx_t_13 = __Pyx_GetItemInt(__pyx_v_v, 2, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 144, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_13);
      __pyx_t_12 = NULL;
      __pyx_t_17 = 0;
      if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_14))) {
      ...
      #if CYTHON_FAST_PYCALL
      if (PyFunction_Check(__pyx_t_14)) {
        PyObject *__pyx_temp[3] = {__pyx_t_12, __pyx_t_13, __pyx_int_0};
        __pyx_t_2 = __Pyx_PyFunction_FastCall(__pyx_t_14, __pyx_temp+1-__pyx_t_17, 2+__pyx_t_17); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 144, __pyx_L1_error)
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_14)) {
        PyObject *__pyx_temp[3] = {__pyx_t_12, __pyx_t_13, __pyx_int_0};
        __pyx_t_2 = __Pyx_PyCFunction_FastCall(__pyx_t_14, __pyx_temp+1-__pyx_t_17, 2+__pyx_t_17); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 144, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_12); __pyx_t_12 = 0;
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      } else
      #endif
      {
        __pyx_t_8 = PyTuple_New(2+__pyx_t_17); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 144, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        if (__pyx_t_12) {
          __Pyx_GIVEREF(__pyx_t_12); PyTuple_SET_ITEM(__pyx_t_8, 0, __pyx_t_12); __pyx_t_12 = NULL;
        }
        __Pyx_GIVEREF(__pyx_t_13);
        PyTuple_SET_ITEM(__pyx_t_8, 0+__pyx_t_17, __pyx_t_13);
        __Pyx_INCREF(__pyx_int_0);
        __Pyx_GIVEREF(__pyx_int_0);
        PyTuple_SET_ITEM(__pyx_t_8, 1+__pyx_t_17, __pyx_int_0);
        __pyx_t_13 = 0;
        __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_14, __pyx_t_8, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 144, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      }
      __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
      __pyx_t_16 = __Pyx_PyObject_IsTrue(__pyx_t_2); if (unlikely(__pyx_t_16 < 0)) __PYX_ERR(0, 144, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      if (unlikely(!__pyx_t_16)) {
        PyErr_SetNone(PyExc_AssertionError);
    ...
    /* "gala/dynamics/mockstream/_coord.pyx":145
 *         v = np.array(R).dot(np.array(w)[3:])
 *         assert np.allclose(v[2], 0)
 *         for j in range(3):             # <<<<<<<<<<<<<<
 *             wrot[j] = x[j]
 ...
 */
    for (__pyx_t_18 = 0; __pyx_t_18 < 3; __pyx_t_18+=1) {
      ...
      /* "gala/dynamics/mockstream/_coord.pyx":146
 *         assert np.allclose(v[2], 0)
 *         for j in range(3):
 *             wrot[j] = x[j]             # <<<<<<<<<<<<<<
 *             wrot[j+3] = v[j]
 * 
 */
      __pyx_t_2 = __Pyx_GetItemInt(__pyx_v_x, __pyx_v_j, unsigned int, 0, __Pyx_PyInt_From_unsigned_int, 0, 0, 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 146, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_19 = __pyx_PyFloat_AsDouble(__pyx_t_2); if (unlikely((__pyx_t_19 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 146, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_t_20 = __pyx_v_j;
      *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_wrot.data) + __pyx_t_20)) )) = __pyx_t_19;

      /* "gala/dynamics/mockstream/_coord.pyx":147
 *         for j in range(3):
 *             wrot[j] = x[j]
 *             wrot[j+3] = v[j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_2 = __Pyx_GetItemInt(__pyx_v_v, __pyx_v_j, unsigned int, 0, __Pyx_PyInt_From_unsigned_int, 0, 0, 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 147, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_19 = __pyx_PyFloat_AsDouble(__pyx_t_2); if (unlikely((__pyx_t_19 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 147, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_t_21 = (__pyx_v_j + 3);
      *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_wrot.data) + __pyx_t_21)) )) = __pyx_t_19;
    }

    /* "gala/dynamics/mockstream/_coord.pyx":149
 *             wrot[j+3] = v[j]
 * 
 *         x2 = np.array(R.T).dot(np.array(wrot)[:3])             # <<<<<<<<<<<<<<
 ...
 *         for j in range(3):
 */
    __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_array); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 149, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_22 = __pyx_v_R;
    __PYX_INC_MEMVIEW(&__pyx_t_22, 1);
    if (unlikely(__pyx_memslice_transpose(&__pyx_t_22) == 0)) __PYX_ERR(0, 149, __pyx_L1_error)
    __pyx_t_13 = __pyx_memoryview_fromslice(__pyx_t_22, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 149, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_13);
    ...
    if (!__pyx_t_12) {
      __pyx_t_14 = __Pyx_PyObject_CallOneArg(__pyx_t_8, __pyx_t_13); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 149, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      __Pyx_GOTREF(__pyx_t_14);
    } else {
      #if CYTHON_FAST_PYCALL
      if (PyFunction_Check(__pyx_t_8)) {
        ...
        __pyx_t_14 = __Pyx_PyFunction_FastCall(__pyx_t_8, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 149, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_12); __pyx_t_12 = 0;
        __Pyx_GOTREF(__pyx_t_14);
        __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      } else
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_8)) {
        PyObject *__pyx_temp[2] = {__pyx_t_12, __pyx_t_13};
        __pyx_t_14 = __Pyx_PyCFunction_FastCall(__pyx_t_8, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 149, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_12); __pyx_t_12 = 0;
        __Pyx_GOTREF(__pyx_t_14);
        __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      } else
      #endif
      {
        ...
        __pyx_t_13 = 0;
        __pyx_t_14 = __Pyx_PyObject_Call(__pyx_t_8, __pyx_t_1, NULL); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 149, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_14);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      }
    }
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_14, __pyx_n_s_dot); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 149, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_array); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 149, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_13 = __pyx_memoryview_fromslice(__pyx_v_wrot, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 149, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_13);
    __pyx_t_12 = NULL;
    ...
    if (!__pyx_t_12) {
      __pyx_t_14 = __Pyx_PyObject_CallOneArg(__pyx_t_1, __pyx_t_13); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 149, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      __Pyx_GOTREF(__pyx_t_14);
    } else {
      #if CYTHON_FAST_PYCALL
      if (PyFunction_Check(__pyx_t_1)) {
        PyObject *__pyx_temp[2] = {__pyx_t_12, __pyx_t_13};
        __pyx_t_14 = __Pyx_PyFunction_FastCall(__pyx_t_1, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 149, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_12); __pyx_t_12 = 0;
        __Pyx_GOTREF(__pyx_t_14);
        __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      } else
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_1)) {
        PyObject *__pyx_temp[2] = {__pyx_t_12, __pyx_t_13};
        __pyx_t_14 = __Pyx_PyCFunction_FastCall(__pyx_t_1, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 149, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_12); __pyx_t_12 = 0;
        __Pyx_GOTREF(__pyx_t_14);
        __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      } else
      #endif
      {
        ...
        __pyx_t_13 = 0;
        __pyx_t_14 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_15, NULL); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 149, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_14);
        __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;
      }
    }
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = __Pyx_PyObject_GetSlice(__pyx_t_14, 0, 3, NULL, NULL, &__pyx_slice__9, 0, 1, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 149, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
    __pyx_t_14 = NULL;
    if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_8))) {
    ...
    if (!__pyx_t_14) {
      ...
      if (PyFunction_Check(__pyx_t_8)) {
        ...
        __pyx_t_2 = __Pyx_PyFunction_FastCall(__pyx_t_8, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 149, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_14); __pyx_t_14 = 0;
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      } else
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_8)) {
        PyObject *__pyx_temp[2] = {__pyx_t_14, __pyx_t_1};
        __pyx_t_2 = __Pyx_PyCFunction_FastCall(__pyx_t_8, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 149, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_14); __pyx_t_14 = 0;
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      } else
      #endif
      {
        ...
        __pyx_t_1 = 0;
        __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_8, __pyx_t_15, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 149, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;
      }
    }
    ...
    /* "gala/dynamics/mockstream/_coord.pyx":150
 * 
 *         x2 = np.array(R.T).dot(np.array(wrot)[:3])
 *         v2 = np.array(R.T).dot(np.array(wrot)[3:])             # <<<<<<<<<<<<<<
 *         for j in range(3):
 *             w2[j] = x2[j]
 */
    __pyx_t_15 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_array); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 150, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_15);
    __pyx_t_22 = __pyx_v_R;
    __PYX_INC_MEMVIEW(&__pyx_t_22, 1);
    if (unlikely(__pyx_memslice_transpose(&__pyx_t_22) == 0)) __PYX_ERR(0, 150, __pyx_L1_error)
    __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_t_22, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 150, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __PYX_XDEC_MEMVIEW(&__pyx_t_22, 1);
    __pyx_t_22.memview = NULL;
    __pyx_t_22.data = NULL;
    ...
    if (!__pyx_t_14) {
      __pyx_t_8 = __Pyx_PyObject_CallOneArg(__pyx_t_15, __pyx_t_1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 150, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __Pyx_GOTREF(__pyx_t_8);
    } else {
      #if CYTHON_FAST_PYCALL
      if (PyFunction_Check(__pyx_t_15)) {
        PyObject *__pyx_temp[2] = {__pyx_t_14, __pyx_t_1};
        __pyx_t_8 = __Pyx_PyFunction_FastCall(__pyx_t_15, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 150, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_14); __pyx_t_14 = 0;
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      } else
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_15)) {
        PyObject *__pyx_temp[2] = {__pyx_t_14, __pyx_t_1};
        __pyx_t_8 = __Pyx_PyCFunction_FastCall(__pyx_t_15, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 150, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_14); __pyx_t_14 = 0;
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      } else
      #endif
      {
        __pyx_t_13 = PyTuple_New(1+1); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 150, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_13);
        __Pyx_GIVEREF(__pyx_t_14); PyTuple_SET_ITEM(__pyx_t_13, 0, __pyx_t_14); __pyx_t_14 = NULL;
        __Pyx_GIVEREF(__pyx_t_1);
        PyTuple_SET_ITEM(__pyx_t_13, 0+1, __pyx_t_1);
        __pyx_t_1 = 0;
        __pyx_t_8 = __Pyx_PyObject_Call(__pyx_t_15, __pyx_t_13, NULL); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 150, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      }
    }
    __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;
    __pyx_t_15 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_dot); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 150, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_15);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_13 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_array); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 150, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_13);
    __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_wrot, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 150, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_14 = NULL;
    ...
    if (!__pyx_t_14) {
      __pyx_t_8 = __Pyx_PyObject_CallOneArg(__pyx_t_13, __pyx_t_1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 150, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __Pyx_GOTREF(__pyx_t_8);
    } else {
      #if CYTHON_FAST_PYCALL
      if (PyFunction_Check(__pyx_t_13)) {
        PyObject *__pyx_temp[2] = {__pyx_t_14, __pyx_t_1};
        __pyx_t_8 = __Pyx_PyFunction_FastCall(__pyx_t_13, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 150, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_14); __pyx_t_14 = 0;
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      } else
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_13)) {
        PyObject *__pyx_temp[2] = {__pyx_t_14, __pyx_t_1};
        __pyx_t_8 = __Pyx_PyCFunction_FastCall(__pyx_t_13, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 150, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_14); __pyx_t_14 = 0;
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      } else
      #endif
      {
        __pyx_t_12 = PyTuple_New(1+1); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 150, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_12);
        __Pyx_GIVEREF(__pyx_t_14); PyTuple_SET_ITEM(__pyx_t_12, 0, __pyx_t_14); __pyx_t_14 = NULL;
        __Pyx_GIVEREF(__pyx_t_1);
        PyTuple_SET_ITEM(__pyx_t_12, 0+1, __pyx_t_1);
        __pyx_t_1 = 0;
        __pyx_t_8 = __Pyx_PyObject_Call(__pyx_t_13, __pyx_t_12, NULL); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 150, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
      }
    }
    __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
    __pyx_t_13 = __Pyx_PyObject_GetSlice(__pyx_t_8, 3, 0, NULL, NULL, &__pyx_slice__10, 1, 0, 0); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 150, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_13);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_8 = NULL;
    if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_15))) {
    ...
    if (!__pyx_t_8) {
      __pyx_t_2 = __Pyx_PyObject_CallOneArg(__pyx_t_15, __pyx_t_13); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 150, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      __Pyx_GOTREF(__pyx_t_2);
    } else {
      #if CYTHON_FAST_PYCALL
      if (PyFunction_Check(__pyx_t_15)) {
        ...
        __pyx_t_2 = __Pyx_PyFunction_FastCall(__pyx_t_15, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 150, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_8); __pyx_t_8 = 0;
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      } else
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_15)) {
        PyObject *__pyx_temp[2] = {__pyx_t_8, __pyx_t_13};
        __pyx_t_2 = __Pyx_PyCFunction_FastCall(__pyx_t_15, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 150, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_8); __pyx_t_8 = 0;
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      } else
      #endif
      {
        ...
        __pyx_t_13 = 0;
        __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_15, __pyx_t_12, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 150, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
      }
    }
    ...
    /* "gala/dynamics/mockstream/_coord.pyx":151
 *         x2 = np.array(R.T).dot(np.array(wrot)[:3])
 *         v2 = np.array(R.T).dot(np.array(wrot)[3:])
 *         for j in range(3):             # <<<<<<<<<<<<<<
 *             w2[j] = x2[j]
 ...
 */
    for (__pyx_t_18 = 0; __pyx_t_18 < 3; __pyx_t_18+=1) {
      ...
      /* "gala/dynamics/mockstream/_coord.pyx":152
 *         v2 = np.array(R.T).dot(np.array(wrot)[3:])
 *         for j in range(3):
 *             w2[j] = x2[j]             # <<<<<<<<<<<<<<
 *             w2[j+3] = v2[j]
 * 
 */
      __pyx_t_2 = __Pyx_GetItemInt(__pyx_v_x2, __pyx_v_j, unsigned int, 0, __Pyx_PyInt_From_unsigned_int, 0, 0, 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 152, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_19 = __pyx_PyFloat_AsDouble(__pyx_t_2); if (unlikely((__pyx_t_19 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 152, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_t_23 = __pyx_v_j;
      *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_w2.data) + __pyx_t_23)) )) = __pyx_t_19;

      /* "gala/dynamics/mockstream/_coord.pyx":153
 *         for j in range(3):
 *             w2[j] = x2[j]
 *             w2[j+3] = v2[j]             # <<<<<<<<<<<<<<
 * 
 *         for j in range(6):
 */
      __pyx_t_2 = __Pyx_GetItemInt(__pyx_v_v2, __pyx_v_j, unsigned int, 0, __Pyx_PyInt_From_unsigned_int, 0, 0, 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 153, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_19 = __pyx_PyFloat_AsDouble(__pyx_t_2); if (unlikely((__pyx_t_19 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 153, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_t_24 = (__pyx_v_j + 3);
      *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_w2.data) + __pyx_t_24)) )) = __pyx_t_19;
    }

    /* "gala/dynamics/mockstream/_coord.pyx":155
 *             w2[j+3] = v2[j]
 * 
 *         for j in range(6):             # <<<<<<<<<<<<<<
 ...
 */
    for (__pyx_t_18 = 0; __pyx_t_18 < 6; __pyx_t_18+=1) {
      ...
      /* "gala/dynamics/mockstream/_coord.pyx":156
 * 
 *         for j in range(6):
 *             assert np.allclose(w[j], w2[j])             # <<<<<<<<<<<<<<
 * 
 ...
 */
      #ifndef CYTHON_WITHOUT_ASSERTIONS
      if (unlikely(!Py_OptimizeFlag)) {
        __pyx_t_15 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_allclose); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 156, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_15);
        __pyx_t_25 = __pyx_v_j;
        __pyx_t_12 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_w.data) + __pyx_t_25)) )))); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 156, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_12);
        __pyx_t_26 = __pyx_v_j;
        __pyx_t_13 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_w2.data) + __pyx_t_26)) )))); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 156, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_13);
        __pyx_t_8 = NULL;
        __pyx_t_17 = 0;
        if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_15))) {
        ...
        if (PyFunction_Check(__pyx_t_15)) {
          ...
          __pyx_t_2 = __Pyx_PyFunction_FastCall(__pyx_t_15, __pyx_temp+1-__pyx_t_17, 2+__pyx_t_17); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 156, __pyx_L1_error)
          __Pyx_XDECREF(__pyx_t_8); __pyx_t_8 = 0;
          __Pyx_GOTREF(__pyx_t_2);
          __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
          __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
        ...
        if (__Pyx_PyFastCFunction_Check(__pyx_t_15)) {
          PyObject *__pyx_temp[3] = {__pyx_t_8, __pyx_t_12, __pyx_t_13};
          __pyx_t_2 = __Pyx_PyCFunction_FastCall(__pyx_t_15, __pyx_temp+1-__pyx_t_17, 2+__pyx_t_17); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 156, __pyx_L1_error)
          __Pyx_XDECREF(__pyx_t_8); __pyx_t_8 = 0;
          __Pyx_GOTREF(__pyx_t_2);
          __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
          __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
        ...
        #endif
        {
          __pyx_t_1 = PyTuple_New(2+__pyx_t_17); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 156, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_1);
          if (__pyx_t_8) {
            __Pyx_GIVEREF(__pyx_t_8); PyTuple_SET_ITEM(__pyx_t_1, 0, __pyx_t_8); __pyx_t_8 = NULL;
          }
          __Pyx_GIVEREF(__pyx_t_12);
          PyTuple_SET_ITEM(__pyx_t_1, 0+__pyx_t_17, __pyx_t_12);
          __Pyx_GIVEREF(__pyx_t_13);
          PyTuple_SET_ITEM(__pyx_t_1, 1+__pyx_t_17, __pyx_t_13);
          __pyx_t_12 = 0;
          __pyx_t_13 = 0;
          __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_15, __pyx_t_1, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 156, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_2);
          __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        }
        __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_t_22, 1);
  __Pyx_AddTraceback("gala.dynamics.mockstream._coord._test_sat_rotation_matrix", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_np);
  __PYX_XDEC_MEMVIEW(&__pyx_v_w, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_wrot, 1);
...
/* Python wrapper */
static PyObject *__pyx_pw_4gala_8dynamics_10mockstream_6_coord_1_test_sat_rotation_matrix(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_4gala_8dynamics_10mockstream_6_coord_1_test_sat_rotation_matrix(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("_test_sat_rotation_matrix (wrapper)", 0);
  __pyx_r = __pyx_pf_4gala_8dynamics_10mockstream_6_coord__test_sat_rotation_matrix(__pyx_self);
...
static PyObject *__pyx_pf_4gala_8dynamics_10mockstream_6_coord__test_sat_rotation_matrix(CYTHON_UNUSED PyObject *__pyx_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("_test_sat_rotation_matrix", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_4gala_8dynamics_10mockstream_6_coord__test_sat_rotation_matrix(0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 122, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "gala/dynamics/mockstream/_coord.pyx":158
 *             assert np.allclose(w[j], w2[j])
 * 
 * cpdef _test_to_sat_coords_roundtrip():             # <<<<<<<<<<<<<<
 *     import numpy as np
...
static PyObject *__pyx_pw_4gala_8dynamics_10mockstream_6_coord_3_test_to_sat_coords_roundtrip(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_f_4gala_8dynamics_10mockstream_6_coord__test_to_sat_coords_roundtrip(CYTHON_UNUSED int __pyx_skip_dispatch) {
  PyObject *__pyx_v_np = NULL;
  long __pyx_v_n;
  __Pyx_memviewslice __pyx_v_w = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_w_sat = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_R = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_w_prime = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_w2 = { 0, 0, { 0 }, { 0 }, { 0 } };
  unsigned int __pyx_v_i;
  unsigned int __pyx_v_j;
  PyObject *__pyx_r = NULL;
  ...
  int __pyx_t_30;
  __Pyx_RefNannySetupContext("_test_to_sat_coords_roundtrip", 0);

  /* "gala/dynamics/mockstream/_coord.pyx":159
 * 
 * cpdef _test_to_sat_coords_roundtrip():
 *     import numpy as np             # <<<<<<<<<<<<<<
 *     np.random.seed(42)
 *     n = 1024
 */
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_numpy, 0, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 159, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_np = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "gala/dynamics/mockstream/_coord.pyx":160
 * cpdef _test_to_sat_coords_roundtrip():
 *     import numpy as np
 *     np.random.seed(42)             # <<<<<<<<<<<<<<
 *     n = 1024
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_random); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 160, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_seed); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 160, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_tuple__11, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 160, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "gala/dynamics/mockstream/_coord.pyx":161
 *     import numpy as np
 *     np.random.seed(42)
 *     n = 1024             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "gala/dynamics/mockstream/_coord.pyx":164
 * 
 *     cdef:
 ...
 *         double[:,::1] R = np.zeros((3,3))
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_random); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 164, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_uniform); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 164, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyDict_NewPresized(1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 164, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_long(__pyx_v_n); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 164, __pyx_L1_error)
  ...
  __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_size, __pyx_t_4) < 0) __PYX_ERR(0, 164, __pyx_L1_error)
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(__pyx_t_4, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 164, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_w = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "gala/dynamics/mockstream/_coord.pyx":165
 *     cdef:
 *         double[:,::1] w = np.random.uniform(size=(n,6))
 *         double[:,::1] w_sat = np.random.uniform(size=(n,6))             # <<<<<<<<<<<<<<
 *         double[:,::1] R = np.zeros((3,3))
 * 
 */
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_random); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 165, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_uniform); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 165, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyDict_NewPresized(1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 165, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_2 = __Pyx_PyInt_From_long(__pyx_v_n); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 165, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_size, __pyx_t_3) < 0) __PYX_ERR(0, 165, __pyx_L1_error)
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(__pyx_t_3, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 165, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_w_sat = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "gala/dynamics/mockstream/_coord.pyx":166
 *         double[:,::1] w = np.random.uniform(size=(n,6))
 *         double[:,::1] w_sat = np.random.uniform(size=(n,6))
 *         double[:,::1] R = np.zeros((3,3))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_zeros); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 166, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_tuple__13, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 166, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(__pyx_t_4, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 166, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_R = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "gala/dynamics/mockstream/_coord.pyx":168
 *         double[:,::1] R = np.zeros((3,3))
 * 
 *         double[::1] w_prime = np.zeros(6)             # <<<<<<<<<<<<<<
 *         double[::1] w2 = np.zeros(6)
 * 
 */
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_zeros); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 168, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_tuple__14, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 168, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_t_3, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 168, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_w_prime = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "gala/dynamics/mockstream/_coord.pyx":169
 * 
 *         double[::1] w_prime = np.zeros(6)
 *         double[::1] w2 = np.zeros(6)             # <<<<<<<<<<<<<<
 * 
 *         unsigned int i, j
 */
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_zeros); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 169, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_tuple__15, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 169, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_t_4, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 169, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_w2 = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "gala/dynamics/mockstream/_coord.pyx":173
 *         unsigned int i, j
 * 
 *     for i in range(n):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "gala/dynamics/mockstream/_coord.pyx":174
 * 
 *     for i in range(n):
 *         sat_rotation_matrix(&w_sat[i,0], &R[0,0])             # <<<<<<<<<<<<<<
 *         to_sat_coords(&w[i,0], &R[0,0], &w_prime[0])
 ...
 */
    ...
    __pyx_t_12 = 0;
    __pyx_t_13 = 0;
    __pyx_f_4gala_8dynamics_10mockstream_6_coord_sat_rotation_matrix((&(*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_w_sat.data + __pyx_t_10 * __pyx_v_w_sat.strides[0]) )) + __pyx_t_11)) )))), (&(*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_R.data + __pyx_t_12 * __pyx_v_R.strides[0]) )) + __pyx_t_13)) )))));

    /* "gala/dynamics/mockstream/_coord.pyx":175
 *     for i in range(n):
 *         sat_rotation_matrix(&w_sat[i,0], &R[0,0])
 *         to_sat_coords(&w[i,0], &R[0,0], &w_prime[0])             # <<<<<<<<<<<<<<
 *         from_sat_coords(&w_prime[0], &R[0,0], &w2[0])
 ...
 */
    ...
    __pyx_t_17 = 0;
    __pyx_t_18 = 0;
    __pyx_f_4gala_8dynamics_10mockstream_6_coord_to_sat_coords((&(*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_w.data + __pyx_t_14 * __pyx_v_w.strides[0]) )) + __pyx_t_15)) )))), (&(*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_R.data + __pyx_t_16 * __pyx_v_R.strides[0]) )) + __pyx_t_17)) )))), (&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_w_prime.data) + __pyx_t_18)) )))));

    /* "gala/dynamics/mockstream/_coord.pyx":176
 *         sat_rotation_matrix(&w_sat[i,0], &R[0,0])
 *         to_sat_coords(&w[i,0], &R[0,0], &w_prime[0])
 *         from_sat_coords(&w_prime[0], &R[0,0], &w2[0])             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_21 = 0;
    __pyx_t_22 = 0;
    __pyx_f_4gala_8dynamics_10mockstream_6_coord_from_sat_coords((&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_w_prime.data) + __pyx_t_19)) )))), (&(*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_R.data + __pyx_t_20 * __pyx_v_R.strides[0]) )) + __pyx_t_21)) )))), (&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_w2.data) + __pyx_t_22)) )))));

    /* "gala/dynamics/mockstream/_coord.pyx":178
 *         from_sat_coords(&w_prime[0], &R[0,0], &w2[0])
 * 
 *         for j in range(6):             # <<<<<<<<<<<<<<
 ...
 */
    for (__pyx_t_23 = 0; __pyx_t_23 < 6; __pyx_t_23+=1) {
      ...
      /* "gala/dynamics/mockstream/_coord.pyx":179
 * 
 *         for j in range(6):
 *             assert np.allclose(w[i,j], w2[j])             # <<<<<<<<<<<<<<
 * 
 ...
 */
      #ifndef CYTHON_WITHOUT_ASSERTIONS
      if (unlikely(!Py_OptimizeFlag)) {
        __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_allclose); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 179, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        __pyx_t_24 = __pyx_v_i;
        __pyx_t_25 = __pyx_v_j;
        __pyx_t_1 = PyFloat_FromDouble((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_w.data + __pyx_t_24 * __pyx_v_w.strides[0]) )) + __pyx_t_25)) )))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 179, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_26 = __pyx_v_j;
        __pyx_t_2 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_w2.data) + __pyx_t_26)) )))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 179, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_2);
        __pyx_t_27 = NULL;
        __pyx_t_28 = 0;
        ...
        if (PyFunction_Check(__pyx_t_3)) {
          PyObject *__pyx_temp[3] = {__pyx_t_27, __pyx_t_1, __pyx_t_2};
          __pyx_t_4 = __Pyx_PyFunction_FastCall(__pyx_t_3, __pyx_temp+1-__pyx_t_28, 2+__pyx_t_28); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 179, __pyx_L1_error)
        ...
        if (__Pyx_PyFastCFunction_Check(__pyx_t_3)) {
          PyObject *__pyx_temp[3] = {__pyx_t_27, __pyx_t_1, __pyx_t_2};
          __pyx_t_4 = __Pyx_PyCFunction_FastCall(__pyx_t_3, __pyx_temp+1-__pyx_t_28, 2+__pyx_t_28); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 179, __pyx_L1_error)
          __Pyx_XDECREF(__pyx_t_27); __pyx_t_27 = 0;
          __Pyx_GOTREF(__pyx_t_4);
          __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
          __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        ...
        #endif
        {
          __pyx_t_29 = PyTuple_New(2+__pyx_t_28); if (unlikely(!__pyx_t_29)) __PYX_ERR(0, 179, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_29);
          if (__pyx_t_27) {
            __Pyx_GIVEREF(__pyx_t_27); PyTuple_SET_ITEM(__pyx_t_29, 0, __pyx_t_27); __pyx_t_27 = NULL;
          }
          __Pyx_GIVEREF(__pyx_t_1);
          PyTuple_SET_ITEM(__pyx_t_29, 0+__pyx_t_28, __pyx_t_1);
          __Pyx_GIVEREF(__pyx_t_2);
          PyTuple_SET_ITEM(__pyx_t_29, 1+__pyx_t_28, __pyx_t_2);
          __pyx_t_1 = 0;
          __pyx_t_2 = 0;
          __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_29, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 179, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_4);
          __Pyx_DECREF(__pyx_t_29); __pyx_t_29 = 0;
        }
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __pyx_t_30 = __Pyx_PyObject_IsTrue(__pyx_t_4); if (unlikely(__pyx_t_30 < 0)) __PYX_ERR(0, 179, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
  ...
  __Pyx_AddTraceback("gala.dynamics.mockstream._coord._test_to_sat_coords_roundtrip", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_np);
  __PYX_XDEC_MEMVIEW(&__pyx_v_w, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_w_sat, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_R, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_w_prime, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_w2, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_4gala_8dynamics_10mockstream_6_coord_3_test_to_sat_coords_roundtrip(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_4gala_8dynamics_10mockstream_6_coord_3_test_to_sat_coords_roundtrip(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("_test_to_sat_coords_roundtrip (wrapper)", 0);
  __pyx_r = __pyx_pf_4gala_8dynamics_10mockstream_6_coord_2_test_to_sat_coords_roundtrip(__pyx_self);
...
static PyObject *__pyx_pf_4gala_8dynamics_10mockstream_6_coord_2_test_to_sat_coords_roundtrip(CYTHON_UNUSED PyObject *__pyx_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("_test_to_sat_coords_roundtrip", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_4gala_8dynamics_10mockstream_6_coord__test_to_sat_coords_roundtrip(0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 158, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "gala/dynamics/mockstream/_coord.pyx":181
 *             assert np.allclose(w[i,j], w2[j])
 * 
 * cpdef _test_car_to_cyl_roundtrip():             # <<<<<<<<<<<<<<
 *     import numpy as np
...
static PyObject *__pyx_pw_4gala_8dynamics_10mockstream_6_coord_5_test_car_to_cyl_roundtrip(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_f_4gala_8dynamics_10mockstream_6_coord__test_car_to_cyl_roundtrip(CYTHON_UNUSED int __pyx_skip_dispatch) {
  PyObject *__pyx_v_np = NULL;
  long __pyx_v_n;
  __Pyx_memviewslice __pyx_v_w = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_cyl = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_w2 = { 0, 0, { 0 }, { 0 }, { 0 } };
  unsigned int __pyx_v_i;
  unsigned int __pyx_v_j;
  PyObject *__pyx_r = NULL;
  ...
  int __pyx_t_22;
  __Pyx_RefNannySetupContext("_test_car_to_cyl_roundtrip", 0);

  /* "gala/dynamics/mockstream/_coord.pyx":182
 * 
 * cpdef _test_car_to_cyl_roundtrip():
 *     import numpy as np             # <<<<<<<<<<<<<<
 *     np.random.seed(42)
 *     n = 1024
 */
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_numpy, 0, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 182, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_np = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "gala/dynamics/mockstream/_coord.pyx":183
 * cpdef _test_car_to_cyl_roundtrip():
 *     import numpy as np
 *     np.random.seed(42)             # <<<<<<<<<<<<<<
 *     n = 1024
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_random); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 183, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_seed); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 183, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  /* "gala/dynamics/mockstream/_coord.pyx":184
 *     import numpy as np
 *     np.random.seed(42)
 *     n = 1024             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "gala/dynamics/mockstream/_coord.pyx":187
 * 
 *     cdef:
 ...
 *         double[::1] w2 = np.zeros(6)
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_random); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 187, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_uniform); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 187, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyDict_NewPresized(1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 187, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_long(__pyx_v_n); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 187, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  PyTuple_SET_ITEM(__pyx_t_4, 1, __pyx_int_6);
  __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_size, __pyx_t_4) < 0) __PYX_ERR(0, 187, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_tuple__17, __pyx_t_1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 187, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(__pyx_t_4, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 187, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_w = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "gala/dynamics/mockstream/_coord.pyx":188
 *     cdef:
 *         double[:,::1] w = np.random.uniform(-10,10,size=(n,6))
 *         double[::1] cyl = np.zeros(6)             # <<<<<<<<<<<<<<
 *         double[::1] w2 = np.zeros(6)
 * 
 */
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_zeros); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 188, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_tuple__18, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 188, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 188, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_cyl = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "gala/dynamics/mockstream/_coord.pyx":189
 *         double[:,::1] w = np.random.uniform(-10,10,size=(n,6))
 *         double[::1] cyl = np.zeros(6)
 *         double[::1] w2 = np.zeros(6)             # <<<<<<<<<<<<<<
 * 
 *         unsigned int i, j
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_zeros); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 189, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_tuple__19, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 189, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_t_4, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 189, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_w2 = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "gala/dynamics/mockstream/_coord.pyx":193
 *         unsigned int i, j
 * 
 *     for i in range(n):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "gala/dynamics/mockstream/_coord.pyx":194
 * 
 *     for i in range(n):
 *         car_to_cyl(&w[i,0], &cyl[0])             # <<<<<<<<<<<<<<
 *         cyl_to_car(&cyl[0], &w2[0])
 ...
 */
    ...
    __pyx_t_11 = 0;
    __pyx_t_12 = 0;
    __pyx_f_4gala_8dynamics_10mockstream_6_coord_car_to_cyl((&(*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_w.data + __pyx_t_10 * __pyx_v_w.strides[0]) )) + __pyx_t_11)) )))), (&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_cyl.data) + __pyx_t_12)) )))));

    /* "gala/dynamics/mockstream/_coord.pyx":195
 *     for i in range(n):
 *         car_to_cyl(&w[i,0], &cyl[0])
 *         cyl_to_car(&cyl[0], &w2[0])             # <<<<<<<<<<<<<<
 *         for j in range(6):
 ...
 */
    __pyx_t_13 = 0;
    __pyx_t_14 = 0;
    __pyx_f_4gala_8dynamics_10mockstream_6_coord_cyl_to_car((&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_cyl.data) + __pyx_t_13)) )))), (&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_w2.data) + __pyx_t_14)) )))));

    /* "gala/dynamics/mockstream/_coord.pyx":196
 *         car_to_cyl(&w[i,0], &cyl[0])
 *         cyl_to_car(&cyl[0], &w2[0])
 *         for j in range(6):             # <<<<<<<<<<<<<<
 *             assert np.allclose(w[i,j], w2[j])
 ...
 */
    for (__pyx_t_15 = 0; __pyx_t_15 < 6; __pyx_t_15+=1) {
      ...
      /* "gala/dynamics/mockstream/_coord.pyx":197
 *         cyl_to_car(&cyl[0], &w2[0])
 *         for j in range(6):
 *             assert np.allclose(w[i,j], w2[j])             # <<<<<<<<<<<<<<
 * 
 ...
 */
      #ifndef CYTHON_WITHOUT_ASSERTIONS
      if (unlikely(!Py_OptimizeFlag)) {
        __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_allclose); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 197, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_16 = __pyx_v_i;
        __pyx_t_17 = __pyx_v_j;
        __pyx_t_2 = PyFloat_FromDouble((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_w.data + __pyx_t_16 * __pyx_v_w.strides[0]) )) + __pyx_t_17)) )))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 197, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_2);
        __pyx_t_18 = __pyx_v_j;
        __pyx_t_3 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_w2.data) + __pyx_t_18)) )))); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 197, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        __pyx_t_19 = NULL;
        __pyx_t_20 = 0;
        if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_1))) {
        ...
        #if CYTHON_FAST_PYCALL
        if (PyFunction_Check(__pyx_t_1)) {
          PyObject *__pyx_temp[3] = {__pyx_t_19, __pyx_t_2, __pyx_t_3};
          __pyx_t_4 = __Pyx_PyFunction_FastCall(__pyx_t_1, __pyx_temp+1-__pyx_t_20, 2+__pyx_t_20); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 197, __pyx_L1_error)
        ...
        if (__Pyx_PyFastCFunction_Check(__pyx_t_1)) {
          PyObject *__pyx_temp[3] = {__pyx_t_19, __pyx_t_2, __pyx_t_3};
          __pyx_t_4 = __Pyx_PyCFunction_FastCall(__pyx_t_1, __pyx_temp+1-__pyx_t_20, 2+__pyx_t_20); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 197, __pyx_L1_error)
          __Pyx_XDECREF(__pyx_t_19); __pyx_t_19 = 0;
          __Pyx_GOTREF(__pyx_t_4);
          __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
          __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        ...
        #endif
        {
          __pyx_t_21 = PyTuple_New(2+__pyx_t_20); if (unlikely(!__pyx_t_21)) __PYX_ERR(0, 197, __pyx_L1_error)
          ...
          __pyx_t_2 = 0;
          __pyx_t_3 = 0;
          __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_21, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 197, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_4);
          __Pyx_DECREF(__pyx_t_21); __pyx_t_21 = 0;
        }
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __pyx_t_22 = __Pyx_PyObject_IsTrue(__pyx_t_4); if (unlikely(__pyx_t_22 < 0)) __PYX_ERR(0, 197, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
  ...
  __Pyx_AddTraceback("gala.dynamics.mockstream._coord._test_car_to_cyl_roundtrip", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_np);
  __PYX_XDEC_MEMVIEW(&__pyx_v_w, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_cyl, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_w2, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_4gala_8dynamics_10mockstream_6_coord_5_test_car_to_cyl_roundtrip(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_4gala_8dynamics_10mockstream_6_coord_5_test_car_to_cyl_roundtrip(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("_test_car_to_cyl_roundtrip (wrapper)", 0);
  __pyx_r = __pyx_pf_4gala_8dynamics_10mockstream_6_coord_4_test_car_to_cyl_roundtrip(__pyx_self);
...
static PyObject *__pyx_pf_4gala_8dynamics_10mockstream_6_coord_4_test_car_to_cyl_roundtrip(CYTHON_UNUSED PyObject *__pyx_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("_test_car_to_cyl_roundtrip", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_4gala_8dynamics_10mockstream_6_coord__test_car_to_cyl_roundtrip(0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 181, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "gala/dynamics/mockstream/_coord.pyx":199
 *             assert np.allclose(w[i,j], w2[j])
 * 
 * cpdef _test_cyl_to_car_roundtrip():             # <<<<<<<<<<<<<<
 *     import numpy as np
...
static PyObject *__pyx_pw_4gala_8dynamics_10mockstream_6_coord_7_test_cyl_to_car_roundtrip(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_f_4gala_8dynamics_10mockstream_6_coord__test_cyl_to_car_roundtrip(CYTHON_UNUSED int __pyx_skip_dispatch) {
  PyObject *__pyx_v_np = NULL;
  long __pyx_v_n;
  __Pyx_memviewslice __pyx_v_cyl = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_w = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_cyl2 = { 0, 0, { 0 }, { 0 }, { 0 } };
  unsigned int __pyx_v_i;
  unsigned int __pyx_v_j;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  size_t __pyx_t_25;
  size_t __pyx_t_26;
  __Pyx_RefNannySetupContext("_test_cyl_to_car_roundtrip", 0);

  /* "gala/dynamics/mockstream/_coord.pyx":200
 * 
 * cpdef _test_cyl_to_car_roundtrip():
 *     import numpy as np             # <<<<<<<<<<<<<<
 *     # np.random.seed(42)
 *     n = 1024
 */
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_numpy, 0, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 200, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_np = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "gala/dynamics/mockstream/_coord.pyx":202
 *     import numpy as np
 *     # np.random.seed(42)
 *     n = 1024             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "gala/dynamics/mockstream/_coord.pyx":205
 * 
 *     cdef:
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_random); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 205, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_uniform); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 205, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_pi); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 205, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = PyNumber_Multiply(__pyx_int_2, __pyx_t_1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 205, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyInt_From_long(__pyx_v_n); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 205, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_size, __pyx_t_5) < 0) __PYX_ERR(0, 205, __pyx_L1_error)
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 205, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_cyl = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "gala/dynamics/mockstream/_coord.pyx":206
 *     cdef:
 *         double[:,::1] cyl = np.random.uniform(0,2*np.pi,size=(n,6))
 *         double[::1] w = np.zeros(6)             # <<<<<<<<<<<<<<
 *         double[::1] cyl2 = np.zeros(6)
 * 
 */
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_zeros); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 206, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_tuple__20, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 206, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_t_3, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 206, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_w = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "gala/dynamics/mockstream/_coord.pyx":207
 *         double[:,::1] cyl = np.random.uniform(0,2*np.pi,size=(n,6))
 *         double[::1] w = np.zeros(6)
 *         double[::1] cyl2 = np.zeros(6)             # <<<<<<<<<<<<<<
 * 
 *         unsigned int i, j
 */
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_zeros); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 207, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_tuple__21, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 207, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 207, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_cyl2 = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "gala/dynamics/mockstream/_coord.pyx":211
 *         unsigned int i, j
 * 
 *     for i in range(n):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
    ...
    /* "gala/dynamics/mockstream/_coord.pyx":212
 * 
 *     for i in range(n):
 *         cyl_to_car(&cyl[i,0], &w[0])             # <<<<<<<<<<<<<<
 *         car_to_cyl(&w[0], &cyl2[0])
 ...
 */
    ...
    __pyx_t_12 = 0;
    __pyx_t_13 = 0;
    __pyx_f_4gala_8dynamics_10mockstream_6_coord_cyl_to_car((&(*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_cyl.data + __pyx_t_11 * __pyx_v_cyl.strides[0]) )) + __pyx_t_12)) )))), (&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_w.data) + __pyx_t_13)) )))));

    /* "gala/dynamics/mockstream/_coord.pyx":213
 *     for i in range(n):
 *         cyl_to_car(&cyl[i,0], &w[0])
 *         car_to_cyl(&w[0], &cyl2[0])             # <<<<<<<<<<<<<<
 *         for j in range(6):
 ...
 */
    __pyx_t_14 = 0;
    __pyx_t_15 = 0;
    __pyx_f_4gala_8dynamics_10mockstream_6_coord_car_to_cyl((&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_w.data) + __pyx_t_14)) )))), (&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_cyl2.data) + __pyx_t_15)) )))));

    /* "gala/dynamics/mockstream/_coord.pyx":214
 *         cyl_to_car(&cyl[i,0], &w[0])
 *         car_to_cyl(&w[0], &cyl2[0])
 *         for j in range(6):             # <<<<<<<<<<<<<<
 *             # assert np.allclose(cyl[i,j], cyl2[j])
 ...
 */
    for (__pyx_t_16 = 0; __pyx_t_16 < 6; __pyx_t_16+=1) {
      ...
      /* "gala/dynamics/mockstream/_coord.pyx":216
 *         for j in range(6):
 *             # assert np.allclose(cyl[i,j], cyl2[j])
 *             if not np.allclose(cyl[i,j], cyl2[j]):             # <<<<<<<<<<<<<<
 ...
 * 
 */
      __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_np, __pyx_n_s_allclose); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 216, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_17 = __pyx_v_i;
      __pyx_t_18 = __pyx_v_j;
      __pyx_t_1 = PyFloat_FromDouble((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_cyl.data + __pyx_t_17 * __pyx_v_cyl.strides[0]) )) + __pyx_t_18)) )))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 216, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_19 = __pyx_v_j;
      __pyx_t_2 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_cyl2.data) + __pyx_t_19)) )))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 216, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_4 = NULL;
      __pyx_t_20 = 0;
      if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_3))) {
      ...
      if (PyFunction_Check(__pyx_t_3)) {
        ...
        __pyx_t_5 = __Pyx_PyFunction_FastCall(__pyx_t_3, __pyx_temp+1-__pyx_t_20, 2+__pyx_t_20); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 216, __pyx_L1_error)
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_3)) {
        PyObject *__pyx_temp[3] = {__pyx_t_4, __pyx_t_1, __pyx_t_2};
        __pyx_t_5 = __Pyx_PyCFunction_FastCall(__pyx_t_3, __pyx_temp+1-__pyx_t_20, 2+__pyx_t_20); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 216, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_4); __pyx_t_4 = 0;
        __Pyx_GOTREF(__pyx_t_5);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      ...
      #endif
      {
        __pyx_t_21 = PyTuple_New(2+__pyx_t_20); if (unlikely(!__pyx_t_21)) __PYX_ERR(0, 216, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_21);
        if (__pyx_t_4) {
        ...
        __pyx_t_1 = 0;
        __pyx_t_2 = 0;
        __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_21, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 216, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
        __Pyx_DECREF(__pyx_t_21); __pyx_t_21 = 0;
      }
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __pyx_t_22 = __Pyx_PyObject_IsTrue(__pyx_t_5); if (unlikely(__pyx_t_22 < 0)) __PYX_ERR(0, 216, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_23 = ((!__pyx_t_22) != 0);
      if (__pyx_t_23) {

        /* "gala/dynamics/mockstream/_coord.pyx":217
 *             # assert np.allclose(cyl[i,j], cyl2[j])
 *             if not np.allclose(cyl[i,j], cyl2[j]):
 *                 print(i,j,cyl[i,j], cyl2[j])             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_5 = __Pyx_PyInt_From_unsigned_int(__pyx_v_i); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 217, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
        __pyx_t_3 = __Pyx_PyInt_From_unsigned_int(__pyx_v_j); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 217, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        __pyx_t_24 = __pyx_v_i;
        __pyx_t_25 = __pyx_v_j;
        __pyx_t_21 = PyFloat_FromDouble((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_cyl.data + __pyx_t_24 * __pyx_v_cyl.strides[0]) )) + __pyx_t_25)) )))); if (unlikely(!__pyx_t_21)) __PYX_ERR(0, 217, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_21);
        __pyx_t_26 = __pyx_v_j;
        __pyx_t_2 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_cyl2.data) + __pyx_t_26)) )))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 217, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_2);
        ...
        __pyx_t_21 = 0;
        __pyx_t_2 = 0;
        __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_print, __pyx_t_1, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 217, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_21);
  __Pyx_AddTraceback("gala.dynamics.mockstream._coord._test_cyl_to_car_roundtrip", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_np);
  __PYX_XDEC_MEMVIEW(&__pyx_v_cyl, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_w, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_cyl2, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_4gala_8dynamics_10mockstream_6_coord_7_test_cyl_to_car_roundtrip(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_4gala_8dynamics_10mockstream_6_coord_7_test_cyl_to_car_roundtrip(PyObject *__pyx_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("_test_cyl_to_car_roundtrip (wrapper)", 0);
  __pyx_r = __pyx_pf_4gala_8dynamics_10mockstream_6_coord_6_test_cyl_to_car_roundtrip(__pyx_self);
...
static PyObject *__pyx_pf_4gala_8dynamics_10mockstream_6_coord_6_test_cyl_to_car_roundtrip(CYTHON_UNUSED PyObject *__pyx_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("_test_cyl_to_car_roundtrip", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_4gala_8dynamics_10mockstream_6_coord__test_cyl_to_car_roundtrip(0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 199, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 *         if itemsize <= 0:
 */
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__22, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 132, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
 ...
 */
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__23, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 135, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_Raise(__pyx_t_3, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_tuple__24, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(1, 138, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 * 
 */
    __pyx_t_5 = __Pyx_PyObject_Call(__pyx_builtin_MemoryError, __pyx_tuple__25, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(1, 147, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
 ...
 */
      __pyx_t_10 = __Pyx_PyObject_Call(__pyx_builtin_MemoryError, __pyx_tuple__26, NULL); if (unlikely(!__pyx_t_10)) __PYX_ERR(1, 175, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_10);
      __Pyx_Raise(__pyx_t_10, 0, 0, 0);
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
 ...
 *         info.len = self.len
 */
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__27, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 191, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_Raise(__pyx_t_3, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
    __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_TypeError, __pyx_tuple__30, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 413, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
 ...
 *             if len(self.view.format) == 1:
 */
      __pyx_t_6 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__31, NULL); if (unlikely(!__pyx_t_6)) __PYX_ERR(1, 490, __pyx_L5_except_error)
      __Pyx_GOTREF(__pyx_t_6);
 ...
 */
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__32, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 515, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_Raise(__pyx_t_3, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
    __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__33, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 565, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_Raise(__pyx_t_2, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = PyNumber_Multiply(__pyx_tuple__34, __pyx_t_2); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 572, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_r = __pyx_t_3;
    __pyx_t_3 = 0;
 ...
 */
      /*else*/ {
        __pyx_t_9 = __Pyx_PyList_Append(__pyx_v_result, __pyx_slice__38); if (unlikely(__pyx_t_9 == ((int)-1))) __PYX_ERR(1, 680, __pyx_L1_error)
      }
      __pyx_L7:;
 ...
 * 
 */
      __pyx_t_5 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__40, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(1, 698, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_Raise(__pyx_t_5, 0, 0, 0);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "gala.dynamics.mockstream._coord.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "gala.dynamics.mockstream._coord.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "gala.dynamics.mockstream._coord.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "gala.dynamics.mockstream._coord._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"_test_sat_rotation_matrix", (PyCFunction)__pyx_pw_4gala_8dynamics_10mockstream_6_coord_1_test_sat_rotation_matrix, METH_NOARGS, 0},
  {"_test_to_sat_coords_roundtrip", (PyCFunction)__pyx_pw_4gala_8dynamics_10mockstream_6_coord_3_test_to_sat_coords_roundtrip, METH_NOARGS, 0},
  {"_test_car_to_cyl_roundtrip", (PyCFunction)__pyx_pw_4gala_8dynamics_10mockstream_6_coord_5_test_car_to_cyl_roundtrip, METH_NOARGS, 0},
  {"_test_cyl_to_car_roundtrip", (PyCFunction)__pyx_pw_4gala_8dynamics_10mockstream_6_coord_7_test_cyl_to_car_roundtrip, METH_NOARGS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec__coord(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__coord},
  {0, NULL}
};
#endif
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "_coord",
    __pyx_k_Coordinate_help_for_generating, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
 ...
 * 
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_int_42); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 124, __pyx_L1_error)
 ...
 *         double[::1] w2 = np.zeros(6)
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_int_6); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 128, __pyx_L1_error)
 ...
 *         double[:,::1] R = np.zeros((3,3))
 */
  __pyx_tuple__3 = PyTuple_Pack(1, __pyx_int_6); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(0, 129, __pyx_L1_error)
 ...
 *         unsigned int i, j
 */
  __pyx_tuple__4 = PyTuple_Pack(1, __pyx_int_6); if (unlikely(!__pyx_tuple__4)) __PYX_ERR(0, 130, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__5 = PyTuple_Pack(2, __pyx_int_3, __pyx_int_3); if (unlikely(!__pyx_tuple__5)) __PYX_ERR(0, 131, __pyx_L1_error)
 ...
 *         assert np.allclose(x[1], 0)
 */
  __pyx_slice__7 = PySlice_New(Py_None, __pyx_int_3, Py_None); if (unlikely(!__pyx_slice__7)) __PYX_ERR(0, 138, __pyx_L1_error)
 ...
 *         for j in range(3):
 */
  __pyx_slice__8 = PySlice_New(__pyx_int_3, Py_None, Py_None); if (unlikely(!__pyx_slice__8)) __PYX_ERR(0, 143, __pyx_L1_error)
 ...
 *         for j in range(3):
 */
  __pyx_slice__9 = PySlice_New(Py_None, __pyx_int_3, Py_None); if (unlikely(!__pyx_slice__9)) __PYX_ERR(0, 149, __pyx_L1_error)
 ...
 *             w2[j] = x2[j]
 */
  __pyx_slice__10 = PySlice_New(__pyx_int_3, Py_None, Py_None); if (unlikely(!__pyx_slice__10)) __PYX_ERR(0, 150, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__11 = PyTuple_Pack(1, __pyx_int_42); if (unlikely(!__pyx_tuple__11)) __PYX_ERR(0, 160, __pyx_L1_error)
 ...
 *         double[::1] w_prime = np.zeros(6)
 */
  __pyx_tuple__12 = PyTuple_Pack(2, __pyx_int_3, __pyx_int_3); if (unlikely(!__pyx_tuple__12)) __PYX_ERR(0, 166, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__12);
  __Pyx_GIVEREF(__pyx_tuple__12);
  __pyx_tuple__13 = PyTuple_Pack(1, __pyx_tuple__12); if (unlikely(!__pyx_tuple__13)) __PYX_ERR(0, 166, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__14 = PyTuple_Pack(1, __pyx_int_6); if (unlikely(!__pyx_tuple__14)) __PYX_ERR(0, 168, __pyx_L1_error)
 ...
 *         unsigned int i, j
 */
  __pyx_tuple__15 = PyTuple_Pack(1, __pyx_int_6); if (unlikely(!__pyx_tuple__15)) __PYX_ERR(0, 169, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__16 = PyTuple_Pack(1, __pyx_int_42); if (unlikely(!__pyx_tuple__16)) __PYX_ERR(0, 183, __pyx_L1_error)
 ...
 *         double[::1] w2 = np.zeros(6)
 */
  __pyx_tuple__17 = PyTuple_Pack(2, __pyx_int_neg_10, __pyx_int_10); if (unlikely(!__pyx_tuple__17)) __PYX_ERR(0, 187, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__18 = PyTuple_Pack(1, __pyx_int_6); if (unlikely(!__pyx_tuple__18)) __PYX_ERR(0, 188, __pyx_L1_error)
 ...
 *         unsigned int i, j
 */
  __pyx_tuple__19 = PyTuple_Pack(1, __pyx_int_6); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 189, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__20 = PyTuple_Pack(1, __pyx_int_6); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(0, 206, __pyx_L1_error)
 ...
 *         unsigned int i, j
 */
  __pyx_tuple__21 = PyTuple_Pack(1, __pyx_int_6); if (unlikely(!__pyx_tuple__21)) __PYX_ERR(0, 207, __pyx_L1_error)
 ...
 *         if itemsize <= 0:
 */
  __pyx_tuple__22 = PyTuple_Pack(1, __pyx_kp_s_Empty_shape_tuple_for_cython_arr); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(1, 132, __pyx_L1_error)
 ...
 *         if not isinstance(format, bytes):
 */
  __pyx_tuple__23 = PyTuple_Pack(1, __pyx_kp_s_itemsize_0_for_cython_array); if (unlikely(!__pyx_tuple__23)) __PYX_ERR(1, 135, __pyx_L1_error)
 ...
 *         self.format = self._format
 */
  __pyx_tuple__24 = PyTuple_Pack(1, __pyx_n_s_ASCII); if (unlikely(!__pyx_tuple__24)) __PYX_ERR(1, 138, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__25 = PyTuple_Pack(1, __pyx_kp_s_unable_to_allocate_shape_and_str); if (unlikely(!__pyx_tuple__25)) __PYX_ERR(1, 147, __pyx_L1_error)
 ...
 *             if self.dtype_is_object:
 */
  __pyx_tuple__26 = PyTuple_Pack(1, __pyx_kp_s_unable_to_allocate_array_data); if (unlikely(!__pyx_tuple__26)) __PYX_ERR(1, 175, __pyx_L1_error)
 ...
 *         info.len = self.len
 */
  __pyx_tuple__27 = PyTuple_Pack(1, __pyx_kp_s_Can_only_create_a_buffer_that_is); if (unlikely(!__pyx_tuple__27)) __PYX_ERR(1, 191, __pyx_L1_error)
 ...
 *         have_slices, index = _unellipsify(index, self.view.ndim)
 */
  __pyx_tuple__30 = PyTuple_Pack(1, __pyx_kp_s_Cannot_assign_to_read_only_memor); if (unlikely(!__pyx_tuple__30)) __PYX_ERR(1, 413, __pyx_L1_error)
 ...
 *             if len(self.view.format) == 1:
 */
  __pyx_tuple__31 = PyTuple_Pack(1, __pyx_kp_s_Unable_to_convert_item_to_object); if (unlikely(!__pyx_tuple__31)) __PYX_ERR(1, 490, __pyx_L1_error)
 ...
 *         if flags & PyBUF_STRIDES:
 */
  __pyx_tuple__32 = PyTuple_Pack(1, __pyx_kp_s_Cannot_create_writable_memory_vi); if (unlikely(!__pyx_tuple__32)) __PYX_ERR(1, 515, __pyx_L1_error)
 ...
 *         return tuple([stride for stride in self.view.strides[:self.view.ndim]])
 */
  __pyx_tuple__33 = PyTuple_Pack(1, __pyx_kp_s_Buffer_view_does_not_expose_stri); if (unlikely(!__pyx_tuple__33)) __PYX_ERR(1, 565, __pyx_L1_error)
 ...
 *         return tuple([suboffset for suboffset in self.view.suboffsets[:self.view.ndim]])
 */
  __pyx_tuple__34 = PyTuple_New(1); if (unlikely(!__pyx_tuple__34)) __PYX_ERR(1, 572, __pyx_L1_error)
 ...
 *             else:
 */
  __pyx_slice__37 = PySlice_New(Py_None, Py_None, Py_None); if (unlikely(!__pyx_slice__37)) __PYX_ERR(1, 677, __pyx_L1_error)
 ...
 *         else:
 */
  __pyx_slice__38 = PySlice_New(Py_None, Py_None, Py_None); if (unlikely(!__pyx_slice__38)) __PYX_ERR(1, 680, __pyx_L1_error)
 ...
 *     return have_slices or nslices, tuple(result)
 */
  __pyx_slice__39 = PySlice_New(Py_None, Py_None, Py_None); if (unlikely(!__pyx_slice__39)) __PYX_ERR(1, 691, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__40 = PyTuple_Pack(1, __pyx_kp_s_Indirect_dimensions_not_supporte); if (unlikely(!__pyx_tuple__40)) __PYX_ERR(1, 698, __pyx_L1_error)
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("sat_rotation_matrix", (void (*)(void))__pyx_f_4gala_8dynamics_10mockstream_6_coord_sat_rotation_matrix, "void (double *, double *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("to_sat_coords", (void (*)(void))__pyx_f_4gala_8dynamics_10mockstream_6_coord_to_sat_coords, "void (double *, double *, double *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("from_sat_coords", (void (*)(void))__pyx_f_4gala_8dynamics_10mockstream_6_coord_from_sat_coords, "void (double *, double *, double *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("car_to_cyl", (void (*)(void))__pyx_f_4gala_8dynamics_10mockstream_6_coord_car_to_cyl, "void (double *, double *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("cyl_to_car", (void (*)(void))__pyx_f_4gala_8dynamics_10mockstream_6_coord_cyl_to_car, "void (double *, double *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_coord(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_coord(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__coord(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__coord(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec__coord(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__coord(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_coord", __pyx_methods, __pyx_k_Coordinate_help_for_generating, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_gala__dynamics__mockstream___coord) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "gala.dynamics.mockstream._coord")) {
      if (unlikely(PyDict_SetItemString(modules, "gala.dynamics.mockstream._coord", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "gala/dynamics/mockstream/_coord.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init gala.dynamics.mockstream._coord", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init gala.dynamics.mockstream._coord");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
